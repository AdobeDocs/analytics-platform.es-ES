...
>abstract="**Esto puede ayudarle** a comprender mejor si la participación a nivel de cuenta tiene tendencia ascendente o descendente, comparar la actividad en todas las cuentas y decidir dónde enfocar los esfuerzos de retención o adquisición.<br/>**En función de lo que aprenda, podría** hacer muchas cosas, como volver a centrarse en las cuentas que están menos comprometidas pero que requieren más atención debido a su importancia."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-opportunity-engagement"
>title="Rastree la participación a nivel de oportunidad y descubra las ofertas que ganen o pierdan impulso."
>abstract="**Esto puede ayudarle** a pronosticar la progresión de la oferta con mayor precisión y a concentrar la habilitación allí donde la participación se intensifique o se estanque.<br/>**En base a lo que aprenda, podría** hacer muchas cosas, como dirigir algunos esfuerzos adicionales en ofertas que están casi cerradas, e investigar por qué otras ofertas están perdiendo impulso."
...
>abstract="**Esto puede ayudarle** a visualizar qué grupos de compra y qué personas dentro de esos grupos están más involucrados, lo que pondrá de relieve las brechas de participación del grupo.<br/>**En función de lo que aprenda, podría** hacer muchas cosas, como intentar relacionarse más con personas de los grupos de compra que no parecen estar involucrados."
...
| [!UICONTROL **Información general sobre la participación de oportunidades B2B**] | Rastree la participación a nivel de oportunidad y descubra las ofertas que ganen o pierdan impulso.<p>**Esto puede ayudarle** a pronosticar la progresión de la oferta con mayor precisión y a concentrar la habilitación allí donde la participación se intensifique o se estanque.</p><p>**En base a lo que aprenda, podría** hacer muchas cosas, como dirigir algunos esfuerzos adicionales en ofertas que están casi cerradas, e investigar por qué otras ofertas están perdiendo impulso.</p> |
| [!UICONTROL **Actividad de grupo de compra B2B**] | Visualice la actividad del grupo de compra en cada cuenta para informar de tácticas de marketing de los grupos de compra y la cuenta.<p>**Esto puede ayudarle** a visualizar qué grupos de compra y qué personas dentro de esos grupos están más involucrados, lo que pondrá de relieve las brechas de participación del grupo.</p><p>**En función de lo que aprenda, podría** hacer muchas cosas, como intentar relacionarse más con personas de los grupos de compra que no parecen estar involucrados.</p> |
