...
>title="Descubra qué contenido y atributos de contenido de medios de pago tienen el mejor rendimiento."
>abstract="**Esto puede ayudarle** a conocer el rendimiento del contenido de los medios de pago a nivel granular. Puede revisar el alcance, la participación, el gasto y la eficacia de los medios de pago en todas las redes, cuentas, campañas, experiencias y recursos. Las métricas y dimensiones de este panel permanecen deliberadamente en el nivel de granularidad del resumen de recursos de medios de pago. No combine conjuntos de datos de resumen con datos de evento.  [Más información](https://experienceleague.adobe.com/es/docs/analytics-platform/using/content-analytics/content-analytics).<br/>**En función de lo que aprenda, podría** hacer muchas cosas, como volverse a centrar en cómo gasta dinero en sus canales de medios de pago, gastar más dinero en campañas de bajo rendimiento o gastar más dinero en campañas con recursos de alto rendimiento."
...
| **Content Analytics de medios de pago** | Descubra qué contenido y atributos de contenido de medios de pago tienen el mejor rendimiento.<p>**Esto puede ayudarle** a conocer el rendimiento del contenido de los medios de pago a nivel granular. Puede revisar el alcance, la participación, el gasto y la eficacia de los medios de pago en todas las redes, cuentas, campañas, experiencias y recursos. Las métricas y dimensiones de este panel permanecen deliberadamente en el nivel de granularidad del resumen de recursos de medios de pago. No combine conjuntos de datos de resumen con datos de evento. Consulte [Content Analytics](/help/content-analytics/content-analytics.md) para obtener más información.<p/><p>**En función de lo que aprenda, podría** hacer muchas cosas, como volverse a centrar en cómo gasta dinero en sus canales de medios de pago, gastar más dinero en campañas de bajo rendimiento o gastar más dinero en campañas con recursos de alto rendimiento.</p> |
...
>abstract="**Esto puede ayudarle a** comprender mejor la información general sobre el público, dónde se originó (RTCDP, Customer Journey Analytics, etc.), su superposición y mucho más.<br/>**En función de lo que aprenda, podría** hacer muchas cosas, como usar los datos para centrarse en los esfuerzos de marketing para este público en concreto o crear experiencias adaptadas para los clientes que abarcan varios públicos.<br/>Esta plantilla usa el Nombre de público, Origen de público, Nombre de público saliente y Origen de público saliente."
...
>abstract="**Esto puede ayudarle** a comprender mejor la eficacia a alto nivel de sus campañas y recorridos. <br/>**A partir de lo que aprenda, puede** hacer muchas cosas, como ajustar sus campañas y recorridos en función de los niveles de participación de su público destinatario."
...
>abstract="**Esto puede ayudarle** a comprender mejor si la participación a nivel de cuenta tiene tendencia a subir o bajar, comparar la actividad en todas las cuentas y decidir dónde enfocar los esfuerzos de retención o adquisición.<br/>**En función de lo que aprenda, puede** hacer muchas cosas, como volver a centrarse en las cuentas que corren menos riesgos, pero que requieren más atención debido a su importancia."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-opportunity-engagement"
>title="Rastree la participación en la oportunidad y descubra las ofertas que ganen o pierdan impulso."
>abstract="**Esto puede ayudarle** a pronosticar la progresión de la oferta con mayor precisión y a concentrar la habilitación allí donde la participación se intensifique o se estanque.<br/>**En función de lo que aprenda, puede** hacer muchas cosas, como dirigir algunos esfuerzos adicionales en ofertas que están casi cerradas, e investigar por qué otras ofertas están perdiendo impulso."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-buying-group-activity"
>title="Visualice la actividad del grupo de compra en cada cuenta para informar de tácticas de marketing de los grupos de compra y la cuenta."
>abstract="**Esto puede ayudarle** a visualizar qué grupos de compra y personas dentro de esos grupos están más involucrados, lo que pondrá de relieve las brechas de participación del grupo.<br/>**En función de lo que aprenda, puede** hacer muchas cosas, como intentar relacionarse más con personas de los grupos de compra que no parecen estar involucrados."
