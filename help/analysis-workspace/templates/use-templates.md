...
>title="Vea la actividad de sus cuentas en todos los eventos, personas y oportunidades."
>abstract="**Esto puede ayudarle** a comprender mejor si la participación a nivel de cuenta es de tendencia ascendente o descendente, comparar la actividad en todas las cuentas y decidir dónde enfocar los esfuerzos de retención o adquisición.<br/>**Según lo que aprendas, podrías** hacer muchas cosas, como volver a enfocar tu atención en las cuentas que están menos comprometidas pero que requieren más atención debido a la importancia de la cuenta."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-opportunity-engagement"
>title="Rastree la participación en el nivel de oportunidad y las ofertas superficiales que ganen o pierdan tracción."
>abstract="**Esto puede ayudarte** a pronosticar la progresión de la oferta con mayor precisión y a concentrar la habilitación donde los picos o las paralizaciones de participación se detienen.<br/>**En base a lo que aprendas, podrías** hacer muchas cosas, como poner algunos esfuerzos adicionales en ofertas que están casi cerradas, e investigar por qué otras ofertas están perdiendo tracción."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-buying-group-activity"
>title="Visualice la actividad del grupo de compra dentro de cada cuenta para informar la cuenta y comprar juegos de marketing de grupo."
>abstract="**Esto puede ayudarte** a visualizar qué grupos compradores y qué personas dentro de esos grupos compradores están más involucrados, lo que resalta las brechas en la participación del grupo.<br/>**En función de lo que sepas, podrías** hacer muchas cosas, como intentar relacionarte más con personas que compran grupos que no parecen estar involucrados."

Las plantillas disponibles son las siguientes:

| Nombre de plantilla | Por qué utilizar esta plantilla<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **Información general sobre la participación en la cuenta B2B**] | Vea la actividad de sus cuentas en todos los eventos, personas y oportunidades.<p>**Esto puede ayudarle** a comprender mejor si la participación a nivel de cuenta es de tendencia ascendente o descendente, comparar la actividad en todas las cuentas y decidir dónde enfocar los esfuerzos de retención o adquisición.</p><p>**Según lo que aprendas, podrías** hacer muchas cosas, como volver a enfocar tu atención en las cuentas que están menos comprometidas pero que requieren más atención debido a la importancia de la cuenta.</p> |
| [!UICONTROL **Información general sobre la participación de oportunidades B2B**] | Rastree la participación en el nivel de oportunidad y las ofertas superficiales que ganen o pierdan tracción.<p>**Esto puede ayudarte** a pronosticar la progresión de la oferta con mayor precisión y a concentrar la habilitación donde los picos o las paralizaciones de participación se detienen.</p><p>**En base a lo que aprendas, podrías** hacer muchas cosas, como poner algunos esfuerzos adicionales en ofertas que están casi cerradas, e investigar por qué otras ofertas están perdiendo tracción.</p> |
| [!UICONTROL **Actividad de grupo de compra B2B**] | Visualice la actividad del grupo de compra dentro de cada cuenta para informar la cuenta y comprar juegos de marketing de grupo.<p>**Esto puede ayudarte** a visualizar qué grupos compradores y qué personas dentro de esos grupos compradores están más involucrados, lo que resalta las brechas en la participación del grupo.</p><p>**En función de lo que sepas, podrías** hacer muchas cosas, como intentar relacionarte más con personas que compran grupos que no parecen estar involucrados.</p> |
