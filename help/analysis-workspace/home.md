...
![Ventana de Analysis Workspace que resalta el extremo y el panel izquierdo, el lienzo y el menú desplegable de vista de datos.](assets/analysis-workspace-overview.png)
...
| **[!UICONTROL Crear intervalo de fechas...]** | **[!UICONTROL *shift+cmd+d *]** | **[!UICONTROL *shift+ctrl+d *]** | Crear un nuevo [intervalo de fecha](/help/components/date-ranges/overview.md). |
