...
>[!NOTE] **[!UICONTROL La atribución]** algorítmica se encuentra actualmente en pruebas limitadas. Consulte las versiones [de funciones de](https://docs.adobe.com/content/help/es-ES/analytics/landing/an-releases.html) Adobe Analytics para obtener más información.
