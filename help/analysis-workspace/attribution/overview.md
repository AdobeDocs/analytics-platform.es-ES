...
* [Panel de atribución](/help/analysis-workspace/c-panels/attribution.md): Tome cualquier dimensión y métrica y compárela rápidamente con diferentes modelos de atribución.
...
* [Aplicar atribución a un desglose](/help/components/dimensions/t-breakdown-fa.md#apply-attribution-models-to-breakdowns): Utilice una atribución no predeterminada en un desglose.
* [Comparar modelos de atribución](/help/components/apply-create-metrics.md#compare-metrics-with-different-attribution-models): Vea rápidamente cómo se comparan los distintos modelos de atribución para cualquier métrica.
...
Vea ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Atribución en tablas de forma libre](https://video.tv.adobe.com/v/38639?captions=spa&quality=12&learn=on){target="_blank"} para ver un vídeo de demostración.
