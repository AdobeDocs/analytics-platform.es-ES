...
- Selecciona **[!UICONTROL Componentes]** > **[!UICONTROL Preferencias]** en la barra principal superior de Customer Journey Analytics (solo disponible para los administradores de productos).
...
| | Mostrar totales | Este total suele ser igual o un subconjunto del [!UICONTROL Total general]. Refleja cualquier segmento de tabla aplicado en la tabla de forma libre, incluida la opción [!UICONTROL Incluir ninguno]. |
...
| | Anclar las anomalías a que escalen el eje Y | El eje Y se escalará con valores de anomalía. |
