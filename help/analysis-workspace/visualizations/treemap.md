...
*Este artículo documenta la visualización del gráfico de rectángulos en **Customer Journey Analytics**.<br/>Ver [Gráfico de rectángulos](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/treemap) para la versión de **Adobe Analytics**de este artículo.*
