...
1. Cree un segmento a partir de un punto de contacto específico en el que esté especialmente interesado y que pueda ser útil para su aplicación en otros informes. Haga clic con el botón derecho en el punto de contacto y seleccione **[!UICONTROL Crear segmento a partir del punto de contacto]**.
   ...
   Cuando se abre el generador de filtros [!UICONTROL Filter Builder], ya contiene el segmento secuencial creado previamente que coincide con el punto de contacto seleccionado:

   ![El Generador de filtros muestra el segmento secuencial generado y rellenado previamente.](assets/fallout-definefilter.png)
...
1. Seleccione los segmentos que quiera comparar en el panel [!UICONTROL Filtro] de la izquierda. En el ejemplo, se seleccionaron tres segmentos: *Detalles del vuelo: Versión de página A*, *Detalles del vuelo: Versión de página B* y *Detalles del vuelo: Versión de página C*.
1. Los tres segmentos se arrastran a la zona de colocación Filtro en la parte superior de la visualización.
