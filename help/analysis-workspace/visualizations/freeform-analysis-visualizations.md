...
Cada visualización tiene su propia configuración. Para acceder a la configuración de visualización, seleccione ![Setting](/help/assets/icons/Setting.svg) **[!UICONTROL Settings]** en el encabezado de visualización para mostrar una ventana emergente.
