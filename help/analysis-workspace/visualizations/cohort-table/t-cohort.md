...
1. En el [Generador de filtros](https://docs.adobe.com/content/help/es-ES/analytics/components/segmentation/segmentation-workflow/seg-build.html), siga editando el segmento y haga clic en **[!UICONTROL Guardar]**.
