...
1. (Opcional) Cree un filtro a partir de una selección.
   ...
   Seleccione celdas (contiguas o no contiguas) y, a continuación, haga clic con el botón derecho > **[!UICONTROL Crear filtro a partir de selección]**.

1. En el [Generador de filtros](/help/components/filters/manage-filters.md), siga editando el segmento y haga clic en **[!UICONTROL Guardar]**.

   El filtro guardado está disponible para su uso en el panel [!UICONTROL Filtro] de [!UICONTROL Analysis Workspace].
