...
1. (Opcional) Cree un filtro a partir de una selección.
   ...
   Seleccione celdas (contiguas o no) y haga clic con el botón derecho > **[!UICONTROL Crear filtro de selección]**.

1. En el [Generador de filtros](/help/components/filters/manage-filters.md), continúe editando el filtro y luego haga clic en **[!UICONTROL Guardar]**.

   El filtro guardado está disponible para usar en el panel [!UICONTROL Filtro] en [!UICONTROL Analysis Workspace].
