...
title: Configurar un informe de análisis de cohorte
...
1. (Opcional) Cree un filtro a partir de una selección.
   ...
   Seleccione celdas (contiguas o no) y haga clic con el botón derecho > **[!UICONTROL Crear filtro a partir de la selección]**.

1. En el [Generador de filtros](/help/components/filters/manage-filters.md), continúe editando el filtro y, a continuación, haga clic en **[!UICONTROL Guardar]**.

   El filtro guardado está disponible para usar en el [!UICONTROL Filtro] panel en [!UICONTROL Analysis Workspace].
