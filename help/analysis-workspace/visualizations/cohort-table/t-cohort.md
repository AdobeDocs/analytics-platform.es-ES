...
Al igual que otras visualizaciones de Analysis Workspace, puede descargar una visualización de cohorte como archivo CSV o PDF. Para obtener más información, consulte [Descargar archivos PDF o CSV](/help/analysis-workspace/curate-share/download-send.md).