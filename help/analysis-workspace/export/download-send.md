...
* Al descargar proyectos como PDF:
   ...
   * Cualquiera [hipervínculos](/help/analysis-workspace/visualizations/freeform-table/freeform-table-hyperlinks.md) Las tablas de forma libre que existen no funcionan en el PDF descargado.
...
Si algún campo de datos etiquetado como confidencial se incluye en la variable [!UICONTROL Vista de datos], la opción para seleccionar y copiar datos de la pantalla está restringida para todos los datos de [!UICONTROL Vista de datos].
