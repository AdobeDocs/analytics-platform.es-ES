...
2. Seleccione **[!UICONTROL Crear esquema]**. Seleccione **[!UICONTROL Perfil individual XDM]** de la lista de opciones.
   ...
   >[!INFO]
   >
   >    Se utiliza un esquema de perfil individual para modelar los _atributos_ del perfil (como fidelidad, estado de fidelidad o puntos de fidelidad). Se utiliza un esquema de eventos de experiencia para modelar el _comportamiento_ de un perfil (como la vista de página, o agregar al carro de compras).
