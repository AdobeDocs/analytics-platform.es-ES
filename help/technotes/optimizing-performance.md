...
# Optimizar Customer Journey Analytics y [!UICONTROL Analysis Workspace] rendimiento
...
| Factor | Definición | Afectado por | Optimización |
| --- | --- | --- | --- |
| **Conexión al Adobe** | Adobe envía 10 llamadas de prueba cuando se abre la página de rendimiento. Representa el porcentaje de las llamadas satisfactorias a Adobe. | Los problemas de Adobe o de red local afectarán este factor. | Consulte status.adobe.com para comprobar si hay algún problema de servicio conocido. A continuación, valide la conexión de red local. |
