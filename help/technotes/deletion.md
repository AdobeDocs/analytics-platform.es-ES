...
| Eliminar un conjunto de datos en [!UICONTROL Customer Journey Analytics] | Al eliminar un conjunto de datos de una conexión en Customer Journey Analytics, las vistas de datos y los proyectos que dependían de ese conjunto de datos dejarán de funcionar. |
