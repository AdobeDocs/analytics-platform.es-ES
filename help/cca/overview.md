...
1. [Cree o edite una conexión](/help/connections/create-connection.md) en Customer Journey Analytics usando el nuevo conjunto de datos recientemente generado y otros conjuntos de datos que desea incluir. Elija el ID personal correcto para cada conjunto de datos.
