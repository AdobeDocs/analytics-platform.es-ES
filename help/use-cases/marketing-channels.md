...
* Las reglas de procesamiento de canal de marketing ya deben estar configuradas. Consulte [Reglas de procesamiento para canales de marketing](https://docs.adobe.com/content/help/es-ES/analytics/components/marketing-channels/c-rules.html) en la guía tradicional de componentes de Analytics.
...
2. [Cree una vista de datos](/help/data-views/create-dataview.md) que incluya las siguientes dimensiones:
   * **`channel.typeAtSource`**: equivalente a la dimensión [Canal de marketing](https://docs.adobe.com/content/help/es-ES/analytics/components/dimensions/marketing-channel.html).
   * **`channel._id`**: equivalente a los [Detalles de canal de marketing](https://docs.adobe.com/content/help/es-ES/analytics/components/dimensions/marketing-detail.html)
