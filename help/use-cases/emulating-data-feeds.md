...
| cust_visid | endUserID._experience.aacustomid.namespace.code | Se utiliza junto con visid_low para identificar de forma exclusiva el ID de visitante de cliente. |
