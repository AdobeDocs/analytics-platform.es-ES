---
title: Configurar análisis de audiencia
...
# Configuración del análisis de público {#configure-audience-analysis}
...
>abstract="Seleccione un campo del esquema relacional que represente el ID de persona. La selección se limita a la lista de campos del esquema que están marcados como Identidad y no tienen un espacio de nombres de identidad."
