...
>title="Modificar la configuración de identidad "
>abstract="Al modificar la configuración de identidad se eliminan los datos de conexión de este conjunto de datos, una vez guardadas las modificaciones en la interfaz Conexiones. Tendrá que iniciar manualmente un relleno de datos para el conjunto de datos, según la nueva configuración.<br/><br/>Es posible que se retrase la creación de informes hasta que se complete el proceso de eliminación."
...
>title="Unificación de identidades"
>abstract="La unificación de identidades deriva datos de identidad de usuario de un conjunto de datos o de un gráfico de identidad. Este proceso puede incluir la combinación de datos de usuario de sesiones autenticadas y no autenticadas.<br/><br/>Usted es responsable de cumplir con las leyes y regulaciones aplicables. Este cumplimiento incluye obtener los permisos de usuario final necesarios antes de activar la vinculación en un conjunto de datos."
>additional-url="https://experienceleague.adobe.com/es/docs/analytics-platform/using/stitching/overview" text="Información general sobre la vinculación"
...
>abstract="Seleccione el área de nombres que desea utilizar para elegir el identificador del gráfico de identidad."
>additional-url="https://experienceleague.adobe.com/es/docs/analytics-platform/using/stitching/overview" text="Información general sobre la vinculación"
...
1. Seleccione **[!UICONTROL Añadir conjuntos de datos]** para añadir los conjuntos de datos configurados a la conexión.
