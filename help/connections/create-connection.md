...
1. En Customer Journey Analytics, seleccione **[!UICONTROL Conexiones]** en el menú principal.
...
En la **[!UICONTROL pantalla Conexiones]** > **[!UICONTROL conexión]** sin título:
...
1. Configure los ajustes de conexión.
   ...
   | [!BADGE ID principal de la edición]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL B2B ]** | Seleccione el ID principal adecuado para su conexión: <ul><li>![Persona ]**de usuario](/help/assets/icons/User.svg)**[!UICONTROL  para un escenario B2C</li><li> ![Creando](/help/assets/icons/Building.svg) **[!UICONTROL Cuenta]** para un escenario B2B.</li></ul> |
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL Contenedores opcionales ]** | Selecciona contenedores adicionales.<ul><li>**[!UICONTROL Cuenta global]**: habilita la configuración de cuentas globales en una conexión.</li><li>**[!UICONTROL Oportunidad]**: habilita la configuración de oportunidades en una conexión.</li><li>**[!UICONTROL Grupo de compra]**: habilita la configuración de grupos de compra en una conexión.</li><ul> |
   ...
   | **[!UICONTROL Agregar conjuntos de datos]** (consulte más abajo) | añadir conjuntos de datos si no aparecen conjuntos de datos en la tabla conjunto de datos. De lo contrario, verá un lista de los conjuntos de datos que ya agregó como parte de la creación de la conexión. |
   ...
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"}<br/>**[!UICONTROL ID de cuenta ]** | El ID de cuenta que se utiliza para admitir la creación de informes basados en cuentas para el conjunto de datos. |
   | [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL ID. de cuenta global ]** | ID de cuenta global que se utiliza para buscar datos de cuenta globales. |
   | [!BADGE ID de grupo de compra de la edición]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"}<br/>**[!UICONTROL B2B ]** | ID del grupo de compra que se utiliza para buscar datos de grupo de compra. |
   | [!BADGE ID de oportunidad de edición]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"}<br/>**[!UICONTROL B2B ]** | El ID de oportunidad que se usa para buscar datos de oportunidad. |
   | **[!UICONTROL ID de la persona]** | El ID de persona que se utiliza para admitir el sistema de informes basado en personas para el conjunto de datos. |
...
## Añadir conjuntos de datos {#add-dataset}
...
El flujo de trabajo permite agregar uno o varios conjuntos de datos Experience Platform al crear una conexión.


1. En el cuadro de diálogo Configuración de conexión, haga clic en **[!UICONTROL Añadir conjuntos de datos]**.

1. En el paso ➊ **[!UICONTROL Seleccionar conjuntos]** de datos, verá una lista de los conjuntos de datos Experience Platform.
   ...
   | **[!UICONTROL Tipo de conjunto de datos]** | El tipo del conjunto de datos: evento, perfil, consulta o resumen. |
   | **[!UICONTROL Número de registros]** | El total de registros del mes anterior para el conjunto de datos en Experience Platform. |
...
1. Seleccione uno o varios conjuntos de datos y seleccione **[!UICONTROL Siguiente]**. [configurará](#configure-datasets) cada conjunto de datos. Al menos un conjunto de datos de evento debe formar parte de la conexión.


## Configurar conjuntos de datos

Configure cada uno de los conjuntos de datos seleccionados, uno por uno, en el paso ➋ Configuración ]**de conjuntos de datos del cuadro de diálogo añadir**[!UICONTROL  conjuntos de **[!UICONTROL datos]**.
...
![Agregar conjunto de datos B2B](assets/add-dataset-b2b.png)

>[!ENDTABS]

| Configuración | Descripción |
| --- | --- |
| [!BADGE ID de cuenta de B2B Edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**** | Solo disponible para conjuntos de datos de evento y para conjuntos de datos de búsqueda que coinciden [con contenedor](/help/getting-started/cja-b2b-concepts-features.md#match-by-container-or-field). Selecciona un ID de cuenta (el identificador único de una cuenta) entre las identidades disponibles definidas en el esquema del conjunto de datos en Experience Platform. |
| [!BADGE ID de oportunidad de edición]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL B2B ]** | Solo disponible para conjuntos de datos evento. Selecciona un ID de oportunidad (el identificador único de una oportunidad) entre las identidades disponibles definidas en el esquema del conjunto de datos en Experience Platform. |
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>**[!UICONTROL ID. de grupo de compra ]** | Solo disponible para conjuntos de datos evento. Selecciona un ID de grupo de compras (el identificador único de un grupo de compras) entre las identidades disponibles definidas en el esquema del conjunto de datos en Experience Platform. |
...
| [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"} **[!UICONTROL tipo de clave coincidente]** | Seleccione cómo unirse a los conjuntos de datos: en función de una **[!UICONTROL coincidencia por campo]** o **[!UICONTROL coincidencia por contenedor]**. Consulte [Coincidencia por contenedor de campo](/help/getting-started/cja-b2b-concepts-features.md#match-by-container-or-field) para obtener más información. |
| **[!UICONTROL Clave de coincidencia]** | Solo disponible para búsqueda o perfil conjuntos de datos. La clave coincidente para unirse a uno de los conjuntos de datos de evento. Si este lista está vacío, es probable que no haya agregado o configurado una conjunto de datos evento. <br/><br/>[!BADGE B2B Edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}<br/>En función del tipo ]**de clave Coincidente seleccionado**[!UICONTROL , seleccione el valor adecuado:<ul><li>**[!UICONTROL Coincidencia por campo]**: seleccione un campo para unirse a uno de los conjuntos de datos evento. Si esta lista está vacía, es probable que no haya añadido ni configurado ningún conjunto de datos de evento.</li><li>**[!UICONTROL Coincidencia por contenedor]**: seleccione una contenedor para unirse a uno de los conjuntos de datos evento. Los contenedores disponibles para seleccionar están determinados por los contenedores que incluyó como parte de la configuración de la conexión. Si esta lista está vacía, es probable que no haya configurado uno o más contenedores.</li></ul> |
| [!BADGE Campo Cuenta de edición]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"}<br/>**[!UICONTROL B2B ]** | El ID de cuenta que se utilizará para los informes basados en cuentas. |
...
| **[!UICONTROL Estado Lote]** | Los posibles indicadores de estado son:<ul><li>Correcto</li><li>Procesamiento de X rellenos</li><li>Off</li></ul> |
| **[!UICONTROL ID de conjunto de datos]** | Este ID se genera automáticamente. |
| **[!UICONTROL Descripción]** | La descripción que se le dio a esta conjunto de datos cuando se creó la conjunto de datos. |
...
| **[!UICONTROL Vista previa: *nombre del conjunto de datos *]** | Muestra una vista previa del conjunto de datos para las primeras 10 filas y las 10 primeras columnas. |
| **[!UICONTROL Eliminar]** | Puede eliminar o eliminar el conjunto de datos y cambiar el ID] de persona o [!UICONTROL el ID] [!BADGE de [!UICONTROL cuenta B2B Edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"} sin eliminar toda la conexión. Eliminar o quitar reduce los costes que implica la ingesta de datos y el engorroso proceso de volver a crear toda la conexión y las vistas de datos asociadas. |

{style="table-layout:auto"}

## Previsualización de la conexión {#preview}

Para previsualización la conexión que ha creado, seleccione ![Conexión de PageSearch](/help/assets/icons/PageSearch.svg) **[!UICONTROL previsualización]** en el cuadro de diálogo Configuración de conexión.
...
[!BADGE Edición B2B]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"}

Para ver un mapa de las relaciones entre los conjuntos de datos que forman parte de la conexión, seleccione ![GraphPathing](/help/assets/icons/GraphPathing.svg) **[!UICONTROL Connection map]** en el cuadro de diálogo Configuración de conexión.

![Mapa de conexión](assets/connectionmap.png)

Este mapa le ayuda a comprender mejor cómo ha definido su conexión y configurar la relación entre su evento, perfil y conjuntos de datos de búsqueda utilizando identificadores.
...
| **[!UICONTROL Perfil]** | Datos que se aplican a su cuenta, personas, usuarios o clientes en los datos de [!UICONTROL Evento]. Por ejemplo, le permite cargar datos de CRM sobre sus clientes. | N/A | Cualquier esquema integrado o personalizado basado en la clase “XDM Individual Perfil”. | Puede elegir qué ID de persona / ID de [!BADGE cuenta B2B edición]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"}  desea incluir. Cada conjunto de datos (excepto los conjuntos de datos de resumen), definidos en [!DNL Experience Platform], tiene su propio conjunto de uno o más ID de persona o ID de cuenta [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"} definidos. Por ejemplo, ID de cookie, ID de unión, ID de usuario, ID de cuenta Code de seguimiento, etc.<br>![ID de persona ](assets/person-id.png)**Nota**: Si crea una conexión que incluye conjuntos de datos con distintos ID, el sistema de informes lo reflejará. Para combinar conjuntos de datos, debe utilizar el mismo ID de persona o ID de cuenta [!BADGE B2B Edition]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Edición B2B Customer Journey Analytics"}. |
...
>[!MORELIKETHIS]
>
>Blog: [Cómo aprovechar los conjuntos de datos de eventos, búsquedas y perfiles en Adobe Systems Customer Journey Analytics](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics-blogs/how-to-leverage-event-lookup-and-profile-datasets-in-adobe/ba-p/681478)
