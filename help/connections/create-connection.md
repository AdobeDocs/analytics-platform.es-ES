...
A veces, es necesario volver a ingerir datos de uno o varios conjuntos de datos en una conexión. Para ello, haga lo siguiente:

1. Para cada conjunto de datos para el que desee volver a introducir los datos:
