...
1. Ahora configure los conjuntos de datos uno a uno.
   ...
   | **[!UICONTROL Tipo de fuente de datos]** | Los tipos de fuentes de datos incluyen: [!UICONTROL Datos web], [!UICONTROL Datos de aplicación móvil], [!UICONTROL Datos POS], [!UICONTROL Datos CRM], [!UICONTROL Datos de encuesta], [!UICONTROL Datos del centro de llamadas], [!UICONTROL Datos del producto], [!UICONTROL Datos de cuentas], [!UICONTROL Datos de transacción], [!UICONTROL Datos de comentarios del cliente], y [!UICONTROL Otros]. |
