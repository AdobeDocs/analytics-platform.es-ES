...
>abstract="Seleccione un ID de persona (el identificador único de una persona) entre las identidades disponibles que haya definido en el esquema del conjunto de datos en Experience Platform."
