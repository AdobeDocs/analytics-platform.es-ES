...
>title="Cambiar el identificador del grupo de compra"
>abstract="Un cambio en el ID del grupo de compra elimina todos los datos existentes en la conexión y vuelve a ingerir todos los datos del conjunto de datos en función del nuevo ID del grupo de compra. Esta acción puede tener implicaciones en los costes. <br/><br/>Cuando selecciona **[!UICONTROL Continuar]**, es posible que se retrase la creación de informes hasta que finalice el proceso."
...
>abstract="Seleccione un ID de persona (el identificador único de una persona) entre las identidades disponibles definidas en el esquema del conjunto de datos en Experience Platform."
