...
>abstract="Cantidad total de datos almacenados en el disco con marca de tiempo para el mes actual (en GB o TB), con un cambio porcentual comparado con el mes anterior."
