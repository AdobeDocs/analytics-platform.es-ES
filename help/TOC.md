...
+ Proyectos de Workspace {#cja-reporting}
   ...
   + [Realizar análisis básico](projects/perform-basic-analysis.md)
   + [Realizar análisis avanzado](projects/perform-adv-analysis.md)
...
+ Componentes {#cja-components}
   ...
   + Proyectos {cja-projects}
      ...
      + [Administrar proyectos](components/projects/manage.md)
