...
description: Ver notas de la versión de Customer Journey Analytics 2026
...
# Notas de la versión Customer Journey Analytics 2026
...
| **Content Analytics: las miniaturas y vistas previas de visualización de dispersión** <br/>[Las miniaturas y vistas previas](/help/content-analytics/report/report.md) están disponibles para los recursos y experiencias en las visualizaciones de dispersión para Content Analytics. | 17 de febrero de 2026 | 2 de marzo de 2026 |
| **Content Analytics: las miniaturas y vistas previas de visualización de barras** <br/>[Las miniaturas y vistas previas](/help/content-analytics/report/report.md) están disponibles para los recursos y experiencias en las visualizaciones de barras (apiladas) y barras horizontales (apiladas) de Content Analytics. | 23 de febrero de 2026 | 9 de marzo de 2026 |
...
| **Compatibilidad con la duplicación de datos**<br/> Con compatibilidad con esquemas basados en modelos y la funcionalidad de captura de datos de cambio (CDC) para conectores de origen específicos en Experience Platform, Customer Journey Analytics podrá admitir la funcionalidad de [duplicación de datos](/help/data-mirror/data-mirror.md) de soluciones de Data Warehouse como [!DNL Snowflake], [!DNL Azure Databricks] y [!DNL Google BigQuery].<p>Póngase en contacto con el equipo de cuentas de Adobe para acceder a Beta.</p> | Lanzamiento de la versión beta: 24 de septiembre de 2025. | 25 de marzo de 2026 |
