...
|---|---|
| **Septiembre de 2026** | |
| Publicaciones de blog incorporadas | Incorporó las siguientes entradas de blog:<ul><li>[El manual de implementación completo para gestionar &quot;Sin valor&quot; en Adobe CJA](https://experienceleaguecommunities.adobe.com/adobe-analytics-3/the-complete-playbook-for-handling-no-value-in-adobe-cja-12769#M598)</li><li>[Casos de uso de salida de datos de Adobe Experience Platform y Customer Journey Analytics en profundidad](https://experienceleaguecommunities.adobe.com/adobe-analytics-3/adobe-experience-platform-customer-journey-analytics-data-egress-use-cases-deep-dive-12725)</li></ul>en nuestros casos de uso de [exportación de datos](/help/use-cases/data-export/overview.md) y un nuevo artículo de caso de uso de [Sin valor](/help/use-cases/data-views/no-value.md). |
...
| **Julio de 2026** | |
| Visibilidad de la marca de integración entrante | Documentación para la [integración entrante de Visibilidad de la marca](/help/integrations/bv.md#inbound-integration). |
...
| **Abril de 2026** | |
| Directrices de campos derivados | Se ha agregado un artículo con [directrices](/help/use-cases/data-views/derived-fields/guidelines.md) (prácticas recomendadas, mecanismos de protección y escollos comunes) para trabajar con campos derivados. |
| Se ha añadido la documentación que falta para dos conjuntos de datos que se pueden incluir al integrar Journey Optimizer | [Dos conjuntos de datos adicionales generados por el sistema que no son de perfil](/help/integrations/ajo.md#high-throughput-add-on-datasets) se incluyen en la conexión cuando el complemento de mensajería transaccional de alto rendimiento está habilitado para su organización de IMS. |
...
| **Marzo de 2026** | |
| Desglose de un panel | Se ha reestructurado la documentación en torno a la [zona de colocación para un panel](/help/analysis-workspace/c-panels/panels.md#drop-zone) a fin de admitir la nueva funcionalidad de [desglose](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel). |
| Nota técnica sobre ID incorrectos (BAVID) | Nueva [nota técnica sobre ID incorrectos](/help/technotes/badids.md). La nota técnica explica la definición de un ID incorrecto, dónde se utilizan los ID incorrectos en la interfaz de Customer Journey Analytics y cómo investigar los datos de la conexión en busca de ID incorrectos. |
| Vista previa del rediseño de conjuntos de datos en Conexiones | Se ha actualizado la documentación para mejorar la experiencia de vista previa de datos al [agregar](/help/connections/create-connection.md#add-datasets) o [editar](/help/connections/create-connection.md#edit-a-dataset) conjuntos de datos en conexiones basadas en personas, incluida la documentación sobre [vinculación de información de vista previa](/help/stitching/use-stitching-ui.md#datasets-preview) adicional para conjuntos de datos habilitados para la vinculación. |
| Miniaturas y vistas previas de Content Analytics | Documentación sobre [miniaturas](/help/content-analytics/report/report.md#thumbnails) y [vistas previas](/help/content-analytics/report/report.md#previews) para visualizaciones adicionales en Content Analytics. |
| **Febrero de 2026** | |
| Anulaciones de encabezado | La documentación del [encabezado adicional anula la configuración](/help/content-analytics/config/guided.md#header-overrides) de Content Analytics. |
| Mecanismo de protección de métricas calculadas | Se ha actualizado el [mecanismo de protección para el número máximo de métricas calculadas de una organización](/help/technotes/guardrails.md#segments-and-calculated-metrics). El máximo ahora es de 50 000. |
| Content Analytics independiente | Se ha agregado documentación para una [configuración independiente de Content Analytics](/help/content-analytics/config/standalone.md). |
| **Enero de 2026** | |
| Diseñar un esquema | Se ha añadido contexto e información importante a [Diseñe su esquema para usarlo con Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-schema-architect.md). |
...
| --- | --- |
| **Diciembre de 2025** | |
| Implicaciones de cambios en la zona protegida | Se han agregado las implicaciones de eliminar o restablecer una zona protegida al artículo [Implicaciones de eliminación y restablecimiento](/help/technotes/deletion.md). |
| **Noviembre de 2025** | |
...
| Cambio de terminología: &quot;Filtros&quot; a &quot;Segmentos&quot; | Anteriormente, Adobe Customer Journey Analytics se refería a los segmentos como &quot;filtros&quot;. Esta terminología se ha adaptado a Adobe Analytics. Los &quot;filtros&quot; ahora se denominan &quot;segmentos&quot;. (Obviamente, los filtros de búsqueda se siguen llamando &quot;filtros&quot;). Se han actualizado la IU y la documentación. |
| **Marzo de 2025** | |
...
| Ordenar componentes en el carril izquierdo | Se ha añadido información acerca de la ordenación de la lista de componentes en el carril izquierdo.Consulte Búsqueda, Filtrar y ordene la sección &quot;lista de componentes&quot; en [Información general sobre componentes](/help/components/overview.md). |
