...
Se han realizado las siguientes actualizaciones en la documentación del Customer Journey Analytics desde su creación.
...
| --- | --- |
| **Junio de 2023** | |
| Vinculación y análisis en canales múltiples | En previsión de los próximos cambios para habilitar la vinculación y aclarar cómo se puede elevar el análisis entre canales mediante la vinculación, la documentación relacionada con la funcionalidad de Análisis entre canales se edita para hacer referencia a [análisis en canales múltiples](../use-cases/cross-channel/cross-channel.md) como la capacidad del Customer Journey Analytics y el caso de uso, y [Vinculación](../stitching/overview.md) como una funcionalidad importante para lograrlo. |
...
| Actualizaciones de métricas calculadas | Se han realizado las siguientes actualizaciones en la documentación de métricas calculadas para alinearla con la funcionalidad actual del Customer Journey Analytics: <ul><li>Se ha actualizado la lista de [métricas calculadas predeterminadas](/help/components/calc-metrics/default-calcmetrics.md) disponible en Customer Journey Analytics</li><li>Capturas de pantalla y procedimientos actualizados en varios artículos de métricas calculadas </li></ul> |
| **Mayo de 2023** | |
...
| Actualización de optimización | Artículo actualizado sobre [Optimización del rendimiento del Customer Journey Analytics](/help/admin/optimizing-performance.md) |
...
| Campos derivados | Documentación añadida para [campos derivados](../data-views/derived-fields/derived-fields.md) funcionalidad. |
| **Abril de 2023** |  |
...
| Filtros de proyecto (filtros específicos y rápidos) | Documentación optimizada sobre filtros de proyecto e información duplicada eliminada. Los pasos para crear filtros ad hoc se combinan ahora con los pasos para [crear filtros rápidos](/help/components/filters/quick-filters.md). |
| **Marzo de 2023** | |
| Integración de datos de gestión de decisiones | Se ha añadido contenido que explica cómo [integrar datos de gestión de decisiones de Adobe Journey Optimizer en Customer Journey Analytics](/help/integrations/ajo-od.md). |
...
| Compatibilidad de funciones actualizadas | Actualizado [Compatibilidad con funciones de Customer Journey Analytics](/help/getting-started/aa-vs-cja/cja-aa.md) con una tabla de funciones disponibles en Customer Journey Analytics, pero no disponibles ni admitidas en AA. |
...
| Actualización de la documentación de Audiences | Después de crear una audiencia, Adobe crea un Experience Platform [segmento de streaming para cada nueva audiencia de Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=es#after-audience-created). |
...
| Cuadros de resultados móviles | Nueva sección de documentación para describir cómo mostrar y ocultar intervalos de fechas de comparación. Consulte [Mostrar comparación de intervalos de fechas](/help/mobile-app/create-scorecard.md#show-comparison-dates) en Customer Journey Analytics. |
| **Enero de 2023** | |
...
| Guías de inicio rápido sobre la ingesta de datos | Nueva sección de documentación sobre cómo [ingesta y uso de datos](/help/data-ingestion/data-ingestion.md) en Customer Journey Analytics. |
...
| Soporte para matrices de objetos de conjuntos de datos de perfil y búsqueda | Actualizado [Usar matrices de objetos](/help/use-cases/object-arrays.md) y [Ingesta de audiencias de Adobe Experience Platform](/help/use-cases/data-ingestion/ingest-aep-segments.md) para reflejar la compatibilidad de la matriz de objetos con los conjuntos de datos de búsqueda y perfil. |
...
| --- | --- |
| **Diciembre de 2022** |  |
| 16 de diciembre de 2022 | Tema nuevo sobre [medición y administración del uso de datos de Customer Journey Analytics](/help/admin/estimate-usage.md). |
| **Octubre de 2022** | |
...
| Agosto de 2022 | Artículo sobre actualizado de forma significativa [control de acceso de Customer Journey Analytics](/help/admin/cja-access-control.md). |
| Agosto de 2022 | Nuevo artículo sobre [Compatibilidad del Customer Journey Analytics con etiquetas y políticas de gobernanza de datos](/help/data-views/data-governance.md). |
...
| Junio de 2022 | Nuevo artículo sobre [comparación del procesamiento de datos entre las funciones de informes de Adobe Analytics y Customer Journey Analytics](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| **Mayo de 2022** | |
| Mayo de 2022 | Artículo sobre actualizado de forma significativa [creación de conexiones](/help/connections/create-connection.md) en Customer Journey Analytics. |
| Mayo de 2022 | Nuevo artículo sobre cómo [administración de bloques de datos en el Report Builder de Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html?lang=es). |
| Mayo de 2022 | Nuevo artículo sobre [ingesta de audiencias de Adobe Experience Platform en Customer Journey Analytics](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **Abril de 2022** | |
...
| Abril de 2022 | Nuevo [Guía del usuario de Customer Journey Analytics para usuarios de Adobe Analytics](/help/getting-started/aa-to-cja-user.md). |
| **Marzo de 2022** | |
| Marzo de 2022 | Nuevo [Documentación de API de anotaciones de Customer Journey Analytics](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| Enero de 2022 | Nuevo artículo sobre [comparación de los datos de Adobe Analytics con los datos de Analytics en Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=es) |
...
| Septiembre de 2021 | Nueva sección sobre [implicaciones de la combinación de grupos de informes](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=es#6-considerations-when-merging-report-suites-in-cja) en Customer Journey Analytics. |
| **Agosto de 2021** | |
| Agosto de 2021 | Nueva sección sobre el [Conexiones](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=es) experiencia en Customer Journey Analytics. |
...
| Febrero de 2021 | Publicado el nuevo [API de Customer Journey Analytics](https://www.adobe.io/cja-apis/docs/) documentación. |
| **Enero de 2021** | |
...
| Diciembre de 2019 | Primer borrador de la documentación del Customer Journey Analytics |
