...
| Protección de métricas calculadas | Se ha actualizado la [protección para el número máximo de métricas calculadas de una organización](/help/technotes/guardrails.md#segments-and-calculated-metrics). El máximo ahora es de 50.000. |
...
| --- | --- |
| **Diciembre de 2025** | |
| Implicaciones de los cambios en la zona protegida | Se agregaron las implicaciones de eliminar o restablecer una zona protegida al artículo [Implicaciones de eliminación y restablecimiento](/help/technotes/deletion.md). |
| **Noviembre de 2025** | |
...
| Cambio de terminología: &quot;Filtros&quot; a &quot;Segmentos&quot; | Anteriormente, Adobe Customer Journey Analytics se refería a los segmentos como &quot;filtros&quot;. Esta terminología se ha adaptado a Adobe Analytics. Los &quot;filtros&quot; ahora se denominan &quot;segmentos&quot;. (Obviamente, los filtros de búsqueda se siguen llamando &quot;filtros&quot;). Se han actualizado la interfaz de usuario y la documentación. |
| **Marzo de 2025** | |
