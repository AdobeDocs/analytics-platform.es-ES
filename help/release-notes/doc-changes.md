...
| --- | --- |
| Octubre de 2022 | Tema nuevo en [Resumen de métricas clave](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/key-metric.html?lang=en) visualización. |
| Octubre de 2022 | Nueva sección sobre [funcionalidad de fecha y hora en las vistas de datos](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=en#date) |
| Octubre de 2022 | Aplicación móvil: Tema nuevo en [vistas de detalles personalizadas](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/create-scorecard.html?lang=en#view-detail-slides). |
...
| Julio de 2022 | Documentación de creación de informes de [Primera sesión](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=en#new-repeat). |
...
| Mayo de 2022 | Nuevo artículo sobre la [ingesta de audiencias de Adobe Experience Platform en CJA](/help/use-cases/ingest-aep-segments.md). |
...
| Fecha | Actualizar descripción |
| --- | --- |
| 13 de noviembre de 2020 | Nuevos temas sobre [Cross-Channel Analytics](/help/connections/cca/overview.md), que le permite volver a escribir el ID de persona de un conjunto de datos y permite una combinación perfecta de varios conjuntos de datos. |
