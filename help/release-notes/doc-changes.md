...
| --- | --- |
| **Junio de 2023** | |
| Acceso de PowerBI y Tableau a las vistas de datos de CJA | El conector SQL del Customer Journey Analytics (CJA) habilita el acceso SQL a las vistas de datos que ha definido en CJA. [Más información](/help/data-views/sql-connector.md) |
...
| Doc sobre &quot;Seleccionar vista de datos de la celda&quot; en Report Builder | Esta función permite a los usuarios seleccionar la vista de datos para un bloque de datos de una celda. [Más información](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/select-data-view.html?lang=es) |
