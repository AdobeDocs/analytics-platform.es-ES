...
| Workspace y componentes | Se ha actualizado la documentación sobre proyectos de Analysis Workspace (proyectos, visualizaciones y paneles) y componentes (anotaciones, dimensiones, métricas (calculadas), segmentos, intervalos de fechas, alertas, proyectos programados y audiencias). |
...
| Documentación del público actualizado | Al [crear una audiencia](https://experienceleague.adobe.com/es/docs/analytics-platform/using/cja-components/audiences/publish?lang=en) a partir de una visualización en Analysis Workspace, los segmentos del panel y los segmentos de columna ahora se incluyen como criterios adicionales. |
| **Septiembre de 2024** | |
...
| Información adicional en la columna &quot;Utilizado en&quot; del administrador de métricas calculadas y del administrador de segmentos | La columna &quot;Utilizado en&quot; en [administrador de métricas calculadas](https://experienceleague.adobe.com/es/docs/analytics-platform/using/cja-components/cja-calcmetrics/cm-workflow/cm-manager?lang=en) y [administrador de segmentos](https://experienceleague.adobe.com/es/docs/analytics-platform/using/cja-components/cja-filters/manage-filters?lang=en) contiene las siguientes áreas de informes nuevos: Componentes de Report Builder y específicos |
| **Agosto de 2024** | |
...
| Se ha añadido documentación sobre la mejora de los permisos para componentes de Workspace solo de proyecto | Si comparte un proyecto con otros usuarios, esos usuarios pueden editar [segmentos rápidos](/help/components/filters/quick-filters.md) y otros componentes solo de proyecto que estén incrustados en el proyecto compartido. |
| **Febrero de 2024** | |
...
| **Abril de 2023** |  |
| Vídeo sobre el uso de segmentos como dimensiones | Se ha actualizado el vídeo sobre el uso de segmentos como dimensión. <p>Este vídeo está enlazado desde la página [Crear segmentos](/help/components/filters/create-filters.md).</p> <p>A continuación se muestra un vínculo directo al vídeo: [Use segmentos como dimensiones en Analysis Workspace](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/filters/use-filters-as-dimensions.html?lang=es).</p> |
| Documentación del segmento | Se ha agregado un artículo sobre el uso del [generador de segmentos](/help/components/filters/filter-builder.md). <p>Documentación optimizada en [Crear segmentos](/help/components/filters/create-filters.md) y [Resumen de segmentación](/help/components/filters/filters-overview.md).</p> |
...
| Segmentos de proyecto (segmentos ad hoc y rápidos) | Documentación optimizada sobre segmentos de proyecto e información duplicada eliminada. Los pasos para crear segmentos ad hoc ahora se combinan con los pasos para [crear segmentos rápidos](/help/components/filters/quick-filters.md). |
| **Marzo de 2023** | |
