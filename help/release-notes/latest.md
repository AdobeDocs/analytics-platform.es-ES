...
| **Compatibilidad con los esquemas ad hoc y basados en modelos** | Los esquemas [ad hoc](https://experienceleague.adobe.com/es/docs/experience-platform/xdm/tutorials/ad-hoc) y basados en modelos se utilizan en los flujos de trabajo de ingesta de datos y duplicación de datos para Experience Platform. |  | 23 de septiembre de 2025 (originalmente planificado para su lanzamiento el 28 de agosto de 2025) |
