...
| **Actualización de la interfaz de uso de conexiones** <br/>En la [interfaz de uso](/help/connections/manage-connections.md#usage) al administrar las conexiones, ahora puede ver los detalles de uso de cada módulo individual, como Customer Journey Analytics o Customer Journey Analytics B2B edition. <br/>Además, ahora puede desglosar los informes de uso de cada uno de los módulos por mes. | 23 de julio de 2026 | 30 de julio de 2026 |
