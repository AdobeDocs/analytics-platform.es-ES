...
| ----------- | ---------- | ------- | ---- |
| **Actualizaciones en la interfaz de uso** | La [interfaz de uso](/help/connections/manage-connections.md#usage) ahora agrega información sobre el volumen de datos principal y el tamaño de fila promedio.<p>Para obtener más información, consulte [Administrar conexiones](/help/connections/manage-connections.md#usage).</p> | | viernes, 04 de septiembre de 2025 |
