...
| **Conector de origen de Analytics: busque grupos de informes en Experience Platform** | Los clientes con un número elevado de grupos de informes ahora pueden buscar el grupo de informes al que desean conectarse dentro del flujo de trabajo de datos del conector de origen de Analytics. <p>Anteriormente, los clientes tenían que paginar una lista potencialmente larga de grupos de informes.</p><p>(Vínculo a la documentación a continuación). | | 30 de octubre de 2025 |
