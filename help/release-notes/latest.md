...
**Última actualización**: viernes, 04 de septiembre de 2025
...
| ----------- | ---------- | ------- | ---- |
| **Actualizaciones en la interfaz de uso** | La [interfaz de uso](/help/connections/manage-connections.md#usage) ahora agrega información sobre el volumen de datos principal y el tamaño de fila promedio. | | viernes, 04 de septiembre de 2025 |
...
| **Compatibilidad con esquemas ad hoc** | [Los esquemas ad hoc](https://experienceleague.adobe.com/es/docs/experience-platform/xdm/tutorials/ad-hoc) se utilizan en varios flujos de trabajo de ingesta de datos de Experience Platform, incluida la ingesta de archivos CSV y la creación de ciertos tipos de conexiones de origen. <p>Esta función habilita la compatibilidad para utilizar los esquemas ad hoc en Customer Journey Analytics. Como parte de la definición de una conexión, ahora puede seleccionar un conjunto de datos basado en un esquema ad-hoc y utilizar los datos en la vista de datos y los proyectos de Workspace.</p> <p>(Vínculo a la documentación a continuación).</p> |  | 18 de septiembre de 2025 (Originalmente planificado para su lanzamiento el 28 de agosto de 2025) |
