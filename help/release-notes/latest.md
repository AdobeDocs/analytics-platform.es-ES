...
| **Content Analytics: datos de medios de pago** <br/>Los medios de pago ya están disponibles como un tercer canal para Content Analytics. Ver actualizaciones de [información general](/help/content-analytics/content-analytics.md), [configuración de canal](/help/content-analytics/config/guided.md#channels), [componentes](/help/content-analytics/report/components.md) e [informes](/help/content-analytics/report/report.md). | | 4 de septiembre de 2026 |
| **B2B: la vinculación de persona a cuenta**<br> La vinculación de cuenta B2B enriquece los conjuntos de datos de evento con información de cuenta y permite un análisis completo del recorrido completo del cliente en Customer Journey Analytics. <p>Cuando los eventos carecen de un ID de cuenta, que Customer Journey Analytics B2B edition requiere para la ingesta, la vinculación de cuentas deriva y agrega esa información automáticamente mediante el conjunto de datos de asignación persona a cuenta que proporcione.</p><p>Para obtener más información, consulte [Vinculación de persona a cuenta B2B](/help/stitching/b2b/b2b-person-to-account-stitching.md).</p> | | 31 de agosto de 2026 |
