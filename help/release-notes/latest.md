...
**Última actualización:** viernes, 08 de mayo de 2025
...
| ----------- | ---------- | ------- | ---- |
| **Dimensión de profundidad del evento** | Se agregó una nueva dimensión Profundidad de evento a la lista de [dimensiones estándar](/help/components/dimensions/overview.md#standard-dimensions) para una vista de datos. |  | viernes, 08 de mayo de 2025 |
