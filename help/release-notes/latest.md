...
**Última actualización**: miércoles, 20 de febrero de 2024
...
| **Detección de bots Experience Edge** | [Detección de bots](https://experienceleague.adobe.com/docs/experience-platform/datastreams/bot-detection.html) permite identificar eventos generados por SDK web, SDK móvil y API de servidor como generados por arañas de web y bots conocidos. | | martes, 29 de abril de 2024 |
