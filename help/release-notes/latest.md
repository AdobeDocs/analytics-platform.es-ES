...
| **Vinculación: recuperar ID persistentes y transitorios de IdentityMap XDM** | Esta función proporciona compatibilidad para utilizar identidades almacenadas en el identityMap XDM en el proceso de vinculación. El identityMap se puede utilizar para el ID persistente o transitorio para la vinculación basada en el campo y se puede utilizar para el ID persistente para la vinculación basada en gráficos.  Puede utilizar un área de nombres específica o la identidad principal desde el identityMap. (Vínculo a la documentación a continuación) |  | martes, 28 de abril de 2025 |
