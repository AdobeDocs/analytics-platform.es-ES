...
| **Adobe Product Analytics: Vista de retención mejorada** | Se han añadido varias funciones a [Retención](https://experienceleague.adobe.com/en/docs/analytics-platform/using/guided-analysis/retention/retention-rates) vista de tarifas para obtener perspectivas de retención más profundas y personalizables:<ul><li>Desvincular eventos de inicio y retorno</li><li>Comparar varios eventos de retorno en una sola vista</li><li>Personalice el modelo de retención aplicado con en o después (sin límite), en cada configuración (limitada) y entre corchetes</li><li>Mostrar y ocultar filas de cohorte individuales en el gráfico</li></ul> | jueves, 10 de abril de 2024 | sábado, 26 de abril de 2024 |
| **Adobe Product Analytics: comparar eventos dentro de un solo paso de canal** | Ahora puede comparar eventos dentro de un solo paso de canal en la [Fricción](https://experienceleague.adobe.com/en/docs/analytics-platform/using/guided-analysis/funnel/friction) vista. Esto resulta especialmente útil cuando el recorrido tiene opciones de paso o un paso en el que se está ejecutando un experimento A/B. | 12 de abril de 2024 | sábado, 26 de abril de 2024 |
