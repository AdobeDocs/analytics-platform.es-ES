...
| **Compatibilidad con Data Mirror** | Con la compatibilidad con esquemas basados en modelos y la funcionalidad de captura de datos modificados (CDC) para conectores de origen específicos en Experience Platform, Customer Journey Analytics podrá admitir la funcionalidad de duplicación de datos de soluciones de almacenamiento de datos como [!DNL Snowflake], [!DNL Azure Databricks] y [!DNL Google BigQuery].<p>Póngase en contacto con el equipo de cuentas de Adobe para acceder a Beta.</p><p>(Vínculo a la documentación a continuación).</p> | Lanzamiento de la versión beta: 24 de septiembre de 2025. | Por determinar |
