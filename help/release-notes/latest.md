...
| **Campos derivados: función matemática** | Le permite hacer operadores matemáticos simples dentro de las vistas de datos para responder preguntas sobre los usuarios. Por ejemplo, puede combinar los ingresos del producto, la garantía y el envío. <p>(Se ha actualizado el siguiente enlace de documentación)</p> | | jueves, 05 de junio de 2024 |
