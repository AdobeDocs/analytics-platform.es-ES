...
**Última actualización:** viernes, 22 de mayo de 2025
...
| **El formato Dimension predeterminado es 2 para las dimensiones de tipo Double** | Para esquemas con tipos de datos Double, el formato de dimensión ahora tiene un valor predeterminado de 2 decimales. Puede cambiar este número de 0 a 5 decimales.<p>Anteriormente, el formato tenía un valor predeterminado de 0 decimales.</p><p>Esto significa que si utiliza dimensiones de tipo doble en los informes de Analysis Workspace, no se muestran lugares decimales de forma predeterminada. Estos mismos informes ahora mostrarán 2 decimales.</p><p>Para obtener más información acerca de cómo actualizar el número de decimales que se muestran para las dimensiones de tipo doble, vea [Formato de configuración de componentes](/help/data-views/component-settings/format.md).</p> | | 29 de mayo de 2025 |
