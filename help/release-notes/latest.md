...
| **Compatibilidad con Data Mirror** | Con la compatibilidad con los esquemas basados en modelos y la funcionalidad de captura de datos de cambio (CDC) para conectores de origen específicos en Experience Platform, Customer Journey Analytics podrá admitir la funcionalidad de Data Mirror de las soluciones de Data Warehouse para Snowflake, Databricks y Google BigQuery. <p>Póngase en contacto con el equipo de cuentas de Adobe para acceder a Beta.</p><p>(Vínculo a la documentación a continuación).</p> | Versión de Beta a partir del 24 de septiembre | Por determinar |
