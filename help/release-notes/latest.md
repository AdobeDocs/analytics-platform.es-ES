...
| **Creación de informes en tiempo real** | La creación de informes en tiempo real en Customer Journey Analytics muestra y actualiza datos y visualizaciones en uno o varios paneles de Analysis Workspace en tiempo real. | | sábado, 15 de agosto de 2025 |
| **Plantillas B2B** | Si obtiene la licencia de Customer Journey Analytics B2B edition, las siguientes plantillas B2B adicionales ya están disponibles en la interfaz de usuario de Adobe templates: <ul><li>información general sobre la participación de la cuenta B2B</li><li>Información general sobre la participación de oportunidad B2B</li><li>Actividad de los grupos de compra B2B</li></ul><p>(Vínculo a la documentación a continuación).</p> |  | sábado, 15 de agosto de 2025 |
