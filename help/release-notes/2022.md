...
| **Informes de sesión de retorno** | Descubra si una sesión en particular fue una sesión de retorno de un usuario.  [Más información](/help/data-views/data-views-usecases.md) | 14 de septiembre de 2022 |
...
| **Visualización de gráficos combinados en el espacio de trabajo** | Los gráficos combinados le permiten comparar métricas de forma más fácil e intuitiva dentro del espacio de trabajo.  [Más información](/help/analysis-workspace/visualizations/combo-charts.md) | Lanzamiento gradual a partir del 14 de septiembre de 2022 |
