...
>[!NOTE]
>
>Debe tener el **Seleccionar** para utilizar la funcionalidad descrita en este artículo. Póngase en contacto con el administrador si no está seguro del paquete de Customer Journey Analytics que tiene.
...
| Opción | Función |
|---------|----------|
| [!UICONTROL **Aprobado**] | <p>Indica que el administrador revisó y aprobó el componente.</p><p>Los administradores ven una opción para lo siguiente [!UICONTROL **Desaprobar**]. Al seleccionar esta opción, se marca el componente como &quot;No aprobado&quot; para los usuarios.</p> |
