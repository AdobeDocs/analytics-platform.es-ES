...
## paquete de Prime {#prime-package}

>[!NOTE]
>
>Debe tener el **paquete Prime** o superior para poder utilizar las funcionalidad descritas en esta sección. Póngase en contacto con el administrador si no sabe qué paquete de Customer Journey Analytics tiene.

## Paquete definitivo {#ultimate-package}

>[!NOTE]
>
>Debe tener el **paquete Ultimate** para poder utilizar los funcionalidad descritos en esta sección. Póngase en contacto con el administrador si no sabe qué paquete de Customer Journey Analytics tiene.

## Opciones de ordenación de componentes {#components-sort-options}

| Opción | Función |
|---------|----------|
| **[!UICONTROL Recomendado]** | Ordene los componentes para cada tipo (dimensión, Métrica, filtro y intervalo de fecha) en función de sus recomendación. Los componentes que usted u otras personas de su organización utilizan con más frecuencia y más recientemente se muestran más arriba en cada lista. |
...
|---|---|
| ![Vistas de datos](/help/assets/filter-dataview.png){width="300"} | La **[!UICONTROL sección vista]** de datos le permite filtrar por vistas de datos. <ul><li>![Puede Search](/help/assets/icons/Search.svg) *Search vistas* de datos a búsqueda para las vistas de datos que puede utilizar para filtrar.</li><li>Puede seleccionar más de un vista de datos. Las vistas de datos disponibles dependen de las selecciones realizadas en otras secciones del panel de filtro.</li><li>Los números indican:<ul><li>**(2)**: El número de vistas de datos seleccionadas (si se seleccionan una o más vistas de datos).</li><li>**3︎⃣**: El número de vistas de datos disponibles para los elementos resultantes del filtro actual.</li><li>4︎⃣: el número de elementos asociados con la vista de datos específica.</li></ul></li></ul> |
...
## Sección de filtro de tipos {#typefiltersection}

| Tipo | Descripción |
|---|---|
| ![Tipo](/help/assets/filter-type.png){width="300"} | La **[!UICONTROL sección Tipo]** permite filtrar por tipo. <ul><li>Puede seleccionar más de un tipo.</li><li>Los números indican:<ul><li>**(2)**: El número de tipos seleccionados (si se seleccionan uno o más tipos).</li><li>**1︎⃣**: El número de tipos disponibles para los elementos resultantes del filtro actual.</li><li>3︎⃣: El número de elementos asociados con el tipo específico.</li></ul></li></ul> |
...
| ![Primer contacto](/help/assets/icons/AttributeFirstTouch.svg) | Primer contacto | Otorga un 100% de crédito al punto de contacto que se ve por primera vez dentro de la ventana retrospectiva del atribución. Las organizaciones suelen utilizar este modelo para comprender imagen de marca o adquisición de cliente. |
| ![Lineal](/help/assets/icons/AttributeLinear.svg) | Lineal | Otorga el mismo crédito a cada punto de contacto que se visualice y que conduzca a una conversión. Es útil cuando los ciclos de Conversión son más largos o requieren una participación más frecuente del cliente. Las organizaciones suelen utilizar este modelo atribución que mide la eficacia de las aplicaciones móviles notificación o con productos basados en suscripción. |
| ![Participación](/help/assets/icons/AttributeParticipation.svg) | Participación | Otorga un 100% de crédito a todos los puntos de contacto únicos. Dado que cada punto de contacto recibe el 100% de crédito, Métrica datos generalmente suman más del 100%. Si un elemento de dimensión aparece varias veces separadas y conduce a una conversión, los valores se deduplican al 100%. Este modelo de atribución es ideal en situaciones en las que desea comprender a qué puntos de contacto se exponen más los clientes. Los medios suelen utilizar este modelo para calcular la velocidad de contenido. Las organizaciones comerciales suelen utilizar este modelo para comprender qué partes de su sitio son esenciales para la conversión. |
...
| ![J inversa](/help/assets/icons/AttributeInverseJ.svg) | J inversa | Otorga un 60% de crédito al primer contacto, un 20% al último contacto y divide el 20% restante en cualquier punto de contacto intermedio. Para las conversiones con un solo punto de contacto, se otorga un 100% de crédito. Para las conversiones con dos puntos de contacto, el 75% de crédito se otorga a la primera interacción y el 25% de crédito a la última. Similar a J-Shaped, este modelo atribución favorece la primera y la última interacción, pero favorece más fuertemente la primera interacción. |
...
* **13 meses** [!BADGE B2B edition]{type=Informative}
...
* **Persona (ventana de informes)**: Busca todas las visitas hasta el primer día del mes del intervalo de fechas actual. Por ejemplo, si el intervalo de fecha del informe es del 15 al 30 de septiembre, el intervalo de fecha de retrospectiva de persona incluye del 1 al 30 de septiembre. Si utiliza esta ventana retrospectiva, ocasionalmente puede ver que dimensión elementos se atribuyen a fechas fuera de su ventana de sistema de informes.
* **Cuenta global (ventana de informe)** [!BADGE B2B edición]{type=Informative}
* **Cuentas (ventana de informe)** [!BADGE B2B Edition]{type=Informative}
* **Oportunidad (ventana de informes)** [!BADGE B2B edition]{type=Informative}
* **Grupo de compra (ventana de informes)** [!BADGE B2B edition]{type=Informative}
...
* Con **Deterioro de tiempo** y una **ventana retrospectiva de persona**, el crédito se divide entre la búsqueda de pago, el medio social, el correo electrónico y la visualización. Con la semivida de 7 días predeterminada:
   ...
   * Intervalo de nueve días entre búsqueda de pago punto de contacto y Conversión. `2^(-9/7) = 0.41`
...
|---------|----------|---------|---------|
| **Secuencia de páginas predefinido** | </br>Sí Combina análisis predefinidos y exploratorios. La ruta eventual se utiliza cuando se utilizan nodos predefinidos en la ruta (los visitantes se cuentan siempre y cuando finalmente pasen de un nodo predefinido al otro). Los siguientes nodos inmediatos (no eventuales) también se pueden mostrar [mostrando los nodos principales basados en nodos](/help/analysis-workspace/visualizations/journey-canvas/configure-journey-canvas.md#show-the-top-nodes-based-on-existing-nodes) existentes. | Sí</br>La ruta puede ser una ruta final o puede restringirse al siguiente punto de contacto | No |
...
| **Muestra dónde abandonaron las personas (abandonaron) y continuaron (abandonaron)** | Sí</br>Muestra tanto los recorridos predefinidos como los exploratorios. | Sí</br>Muestra recorridos predefinidos | Sí</br>Muestra recorridos exploratorios |
...
| **recorridos Adobe Journey Optimizer** | </br>Sí Viajes abiertos desde Journey Optimizer para una mayor análisis y personalización. | No | No |
...
>[!NOTE]
> 
>Utilice la información de esta página para responder a las preguntas de la Guía de actualización de Customer Journey Analytics. <br><br>Para acceder a la guía desde Customer Journey Analytics, selecciona la pestaña **[!UICONTROL Workspace]** y, a continuación, selecciona **[!UICONTROL Actualizar a Customer Journey Analytics]** en el panel izquierdo. Siga las instrucciones que aparecen en pantalla.

## Actualización de lista de comprobación: paso siguiente {#upgrade-note-step}

>[!NOTE]
> 
>Siga los pasos de esta página solo después de completar todos los pasos de actualización anteriores. Puede seguir los pasos de actualización recomendados (recomendados para la mayoría de las organizaciones) o puede seguir los pasos generados dinámicamente para su organización con la Guía de actualización de Customer Journey Analytics. <ul><li>**Pasos de actualización recomendados** (recomendado para la mayoría de las organizaciones)<p>Un conjunto de pasos que conducen a una implementación de Customer Journey Analytics ideal.</p><p>Para obtener información detallada, consulte [Actualizar de Adobe Analytics a Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md).</p></li><li>**Guía de actualización de Customer Journey Analytics** (Pasos personalizados adaptados a las necesidades específicas de su organización)<p>Hay disponible una nueva guía de actualización que genera dinámicamente pasos de actualización adaptados a su organización y a sus circunstancias únicas.</p><p>Para acceder a la guía desde Customer Journey Analytics, selecciona la pestaña **[!UICONTROL Workspace]** y, a continuación, selecciona **[!UICONTROL Actualizar a Customer Journey Analytics]** en el panel izquierdo. Siga las instrucciones que aparecen en la pantalla.</p></li></ul>

## Paso final de la lista de comprobación de actualización {#upgrade-final-step}

1. Continuar seguir los pasos](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md#recommended-upgrade-steps-for-most-organizations) de [actualización recomendados o los pasos de actualización generados dinámicamente en la Guía de actualización de Customer Journey Analytics. Para acceder al guía desde Customer Journey Analytics, seleccione el **[!UICONTROL Espacio de trabajo]** pestaña y, a continuación, seleccione **[!UICONTROL Actualizar a Customer Journey Analytics]** en el panel izquierdo. Siga las instrucciones que aparecen en pantalla.
...
>[!WARNING]
>
>Este artículo forma parte del borrador de la documentación de Content Analytics. Todo el borrador de la documentación de Content Analytics sigue estando sujeto a cambios y no se puede derivar ninguna obligación legal de la versión actual de este artículo o de cualquier otro artículo que forme parte de la documentación de Content Analytics.
>


## Borrador de documentación de Customer Journey Analytics B2B edition {#draft-b2b}

>[!AVAILABILITY]
>
>La funcionalidad descrita en este artículo, y cualquier otro artículo o funcionalidad con la insignia [!BADGE B2B edition]{type=Informative}<br/>Además, [!BADGE B2B edition]{type=Informative}[!BADGE B2B edition]{type=Informative}<br/>Esta nota se eliminará cuando la funcionalidad esté disponible de forma general. Para obtener información sobre el proceso de lanzamiento de Customer Journey Analytics, consulte [lanzamientos de características de Customer Journey Analytics](/help/release-notes/releases.md).
>
