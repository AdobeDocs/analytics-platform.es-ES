...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Introducción a las métricas calculadas](https://video.tv.adobe.com/v/35863/?captions=spa&quality=12&learn=on){target="_blank"} para ver un vídeo de demostración.
...
| Tarea | Descripción |
| --- | --- |
| Planificar | En especial, para las métricas que se van a aprobar oficialmente ![Círculo de marca de verificación](/help/assets/icons/CheckmarkCircle.svg), planifique y estructure cuidadosamente las métricas calculadas que prevea que se van a utilizar con frecuencia. |
