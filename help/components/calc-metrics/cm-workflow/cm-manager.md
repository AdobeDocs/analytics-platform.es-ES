...
|:---:|---|---|
| ![AgregarCírculo](/help/assets/icons/AddCircle.svg) | **[!UICONTROL Agregue]** | Agregar otra métrica calculada con el [Creador de métricas calculadas](cm-build-metrics.md). |
