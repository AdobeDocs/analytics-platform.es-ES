...
Utiliza [Administrador de segmentos](seg-manage.md) para administrar segmentos.
...
- **Modularidad**: defina segmentos con la modularidad en mente. Los usuarios de tus segmentos deberían poder [apilar segmentos](seg-builder.md#stack-filters) fácilmente para crear nuevos segmentos poderosos.
...
>&#x200B;>[Administrar segmentos](seg-manage.md)
