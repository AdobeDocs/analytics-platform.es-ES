...
Si no tiene acceso a los segmentos compartidos, puede usarlos en proyectos o como parte de la [configuración de una vista de datos](/help/data-views/session-settings.md).
