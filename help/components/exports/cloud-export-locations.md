...
>title="Prefijo"
>abstract="La carpeta raíz dentro del contenedor en el que desea colocar los datos. Especifique un nombre de carpeta y, a continuación, añada una barra inclinada después del nombre para crear la carpeta. Por ejemplo, `folder_name/`"
...
1. Especifique la siguiente información:
   ...
   | [!UICONTROL **Poner la ubicación a disposición de todos los usuarios de su organización**] | Active esta opción para permitir que otros usuarios de su organización utilicen la ubicación. <p>Tenga en cuenta lo siguiente al compartir ubicaciones:</p><ul><li>Las ubicaciones que comparta no se pueden dejar de compartir.</li><li>Las ubicaciones compartidas solo las puede editar el propietario de la ubicación.</li><li>Las ubicaciones solo se pueden compartir si también se comparte la cuenta a la que está asociada la ubicación.</li></ul> |
...
>[!IMPORTANT]
>
>Al exportar informes de Customer Journey Analytics a Adobe Experience Platform Data Landing Zone, asegúrese de descargar los datos en un plazo de 7 días y, a continuación, elimínelos de AEP Data Landing Zone. Después de 7 días, los datos se eliminan automáticamente de la zona de aterrizaje de datos de AEP.

1. Empiece a crear una ubicación de exportación en la nube de una de las siguientes maneras:

   * Desde la página Exportaciones como se describe anteriormente, en [Empezar a crear una ubicación de exportación en la nube](#begin-creating-a-cloud-export-location)
...
1. En la sección [!UICONTROL **Propiedades de ubicación**] del cuadro de diálogo [!UICONTROL **Agregar ubicación**], especifique la siguiente información para configurar una ubicación ARN de la función de Amazon S3:
   ...
   | [!UICONTROL **Prefijo**] | La carpeta dentro del bloque en el que quiere colocar los datos. Especifique un nombre de carpeta y, a continuación, añada una barra inclinada después del nombre para crear la carpeta. Por ejemplo, folder_name/ |
   | [!UICONTROL **Nombre de archivo y ruta**] | Especifique un nombre de archivo personalizado dinámico para usar en las exportaciones automatizadas que se envían a esta ubicación. También puede anteponer al nombre del archivo una ruta de acceso dinámica personalizada. <p>Esta opción le permite automatizar la creación de nombres de archivo y la ubicación de carpetas, de modo que los nombres de archivo sean predecibles y estén organizados en carpetas de forma lógica. Por ejemplo, los nombres de archivo pueden asignarse según el día en que se entregaron y luego colocarse en carpetas que correspondan con cada mes.</p><p>Utilice cualquiera de las siguientes variables en el nombre de archivo y ruta para hacerlas dinámicas:</p><ul><li>**{yyyy}**: año natural de 4 dígitos (distingue mayúsculas de minúsculas)</li><li>**{yy}**: año natural de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{MM}**: mes de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{dd}**: día de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{HH}**: hora de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{mm}**: minutos de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{ss}**: segundos de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{fff}**: nanosegundos de 3 dígitos (distingue mayúsculas de minúsculas)</li><li>**{instance_id}**: UUID de solicitud (instancia)</li><li>**{export_id}**: UUID de exportación (programación)</li><li>**{idx}**: inicio del índice desde 0 (incrementado para cada archivo)</li><li>**{total}**: número de archivo total para todo el trabajo de transferencia</li><li>**{completion_millis}**: tiempo de transferencia en milisegundos</li></ul></p><p>Por ejemplo, si especifica `${yyyy}/${MM}/${dd}/my-report-${instance_id} -${idx}`, una exportación que se envíe automáticamente a este destino el 15 de enero de 2026 tendría la siguiente ruta de archivo y nombre: [prefix_folder_name]/2026/01/15/my-report-[UUID]-1.csv</p> |
...
1. En la sección [!UICONTROL **Propiedades de ubicación**] del cuadro de diálogo [!UICONTROL **Agregar ubicación**], especifique la siguiente información para configurar una ubicación RBAC de Azure:
   ...
   | [!UICONTROL **Nombre de archivo y ruta**] | Especifique un nombre de archivo personalizado dinámico para usar en las exportaciones automatizadas que se envían a esta ubicación. También puede anteponer al nombre del archivo una ruta de acceso dinámica personalizada. <p>Esta opción le permite automatizar la creación de nombres de archivo y la ubicación de carpetas, de modo que los nombres de archivo sean predecibles y estén organizados en carpetas de forma lógica. Por ejemplo, los nombres de archivo pueden asignarse según el día en que se entregaron y luego colocarse en carpetas que correspondan con cada mes.</p> <p>Utilice cualquiera de las siguientes variables en el nombre de archivo y ruta para hacerlas dinámicas:</p><ul><li>**{yyyy}**: año natural de 4 dígitos (distingue mayúsculas de minúsculas)</li><li>**{yy}**: año natural de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{MM}**: mes de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{dd}**: día de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{HH}**: hora de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{mm}**: minutos de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{ss}**: segundos de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{fff}**: nanosegundos de 3 dígitos (distingue mayúsculas de minúsculas)</li><li>**{instance_id}**: UUID de solicitud (instancia)</li><li>**{export_id}**: UUID de exportación (programación)</li><li>**{idx}**: el índice comienza desde 0 (se incrementa para cada archivo)</li><li>**{total}**: número de archivo total para todo el trabajo de transferencia</li><li>**{completion_millis}**: Tiempo de transferencia en milisegundos</li></ul></p><p>Por ejemplo, si especifica `${yyyy}/${MM}/${dd}/my-report-${instance_id} -${idx}`, una exportación que se envíe automáticamente a este destino el 15 de enero de 2026 tendrá la siguiente ruta de archivo y nombre: [prefix_folder_name]/2026/01/15/my-report-[UUID]-1.csv</p> |
...
1. En la sección [!UICONTROL **Propiedades de ubicación**] del cuadro de diálogo [!UICONTROL **Agregar ubicación**], especifique la siguiente información para configurar una ubicación de Snowflake:
   ...
   | Campo | Función |
   |---------|----------|
   | [!UICONTROL **DB**] | La base de datos especificada debe ser una base de datos existente. El rol que ha creado debe tener privilegios para tener acceso a esta base de datos.<p>Es la base de datos asociada al nombre de etapa.</p><p>Puede conceder este privilegio de función a la base de datos en Snowflake mediante el siguiente comando: `GRANT USAGE ON DATABASE <your_database> TO ROLE <your_role>;`</p> <p>Para obtener más información, consulte la página [Comandos de base de datos, esquema y uso compartido en la documentación del Snowflake](https://docs.snowflake.com/en/sql-reference/commands-database).</p> |
   | [!UICONTROL **Esquema**] | El esquema especificado debe ser un esquema existente. La función que ha creado debe tener privilegios para acceder a este esquema.<p>Esquema asociado al nombre de etapa.</p><p>Puede conceder el rol que creó privilegios al esquema en Snowflake mediante el siguiente comando: `GRANT USAGE ON SCHEMA <your_database>.<your_schema> TO ROLE <your_role>;`</p><p>Para obtener más información, consulte la página [Comandos de base de datos, esquema y uso compartido en la documentación del Snowflake](https://docs.snowflake.com/en/sql-reference/commands-database).</p> |
   | [!UICONTROL **Nombre de fase**] | Nombre de la fase interna en la que se almacenan los archivos de datos en Snowflake.<p>Asegúrese de que la función especificada en la cuenta tiene acceso de lectura y escritura a este nombre de fase. (Dado que concede acceso de lectura y escritura, le recomendamos que utilice una fase que solo utilice Adobe).</p><p>Puede conceder acceso de lectura y escritura al nombre de la fase en Snowflake mediante el siguiente comando: `GRANT READ, WRITE ON STAGE <your_database>.<your_schema>.<your_stage_name> TO ROLE <your_role>;`</p> <p>Para obtener información acerca de cómo conceder privilegios a un rol, vea [Conceder privilegios en la documentación de Snowflake](https://docs.snowflake.com/en/sql-reference/sql/grant-privilege).</p> <p>Para obtener más información sobre el nombre del escenario, consulte la página [Selección de un escenario interno para archivos locales en la documentación del Snowflake](https://docs.snowflake.com/en/user-guide/data-load-local-file-system-create-stage).</p> |
   | [!UICONTROL **Ruta del escenario**] | La ruta a la ubicación donde se almacenan los archivos de datos en Snowflake. <p>Para obtener más información, consulte la página [Elección de una fase interna para archivos locales en la documentación de Snowflake](https://docs.snowflake.com/en/user-guide/data-load-local-file-system-create-stage).</p> |
   | [!UICONTROL **Nombre de archivo y ruta**] | Especifique un nombre de archivo personalizado dinámico para usar en las exportaciones automatizadas que se envían a esta ubicación. También puede anteponer al nombre del archivo una ruta de acceso dinámica personalizada. <p>Esta opción le permite automatizar la creación de nombres de archivo y la ubicación de carpetas, de modo que los nombres de archivo sean predecibles y estén organizados en carpetas de forma lógica. Por ejemplo, los nombres de archivo pueden asignarse según el día en que se entregaron y luego colocarse en carpetas que correspondan con cada mes.</p><p>Utilice cualquiera de las siguientes variables en el nombre de archivo y ruta para hacerlas dinámicas:</p><ul><li>**{yyyy}**: año natural de 4 dígitos (distingue mayúsculas de minúsculas)</li><li>**{yy}**: año natural de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{MM}**: mes de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{dd}**: día de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{HH}**: hora de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{mm}**: minutos de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{ss}**: segundos de 2 dígitos (distingue mayúsculas de minúsculas)</li><li>**{fff}**: nanosegundos de 3 dígitos (distingue mayúsculas de minúsculas)</li><li>**{instance_id}**: UUID de solicitud (instancia)</li><li>**{export_id}**: UUID de exportación (programación)</li><li>**{idx}**: inicio del índice desde 0 (incrementado para cada archivo)</li><li>**{total}**: número total de archivos para todo el trabajo de transferencia</li><li>**{completion_millis}**: tiempo de transferencia en milisegundos</li></ul></p><p>Por ejemplo, si especifica `${yyyy}/${MM}/${dd}/my-report-${instance_id} -${idx}`, una exportación que se envíe automáticamente a este destino el 15 de enero de 2026 tendría la siguiente ruta de archivo y nombre: [prefix_folder_name]/2026/01/15/my-report-[UUID]-1.csv</p> |
