...
1. **[!UICONTROL Selector de vista de datos]**: Permite seleccionar el grupo de informes en el que se guardará este filtro. Puede seguir utilizando el filtro en todas las vistas de datos.
