...
1. Comience a crear una alerta accediendo al generador de alertas. <!-- add this back in after the other methods are available like in AA and make a bulleted list: "You can access the alert builder in any of the following ways:" --> En el Customer Journey Analytics, seleccione **[!UICONTROL Componentes]** > [!UICONTROL **Alertas**] > **[!UICONTROL Crear nueva alerta]**.
