...
Cuando se solicita un informe que contiene una dimensión con demasiados valores únicos, Analysis Workspace muestra un indicador en el encabezado de la dimensión que indica que no se incluyen todos los elementos de dimensión. Por ejemplo, **[!UICONTROL Filas: 1-50 de más de 22.343.156]**. La palabra clave **[!UICONTROL more than]** indica que se aplicó alguna optimización al informe para devolver los elementos de dimensión más importantes.
...
Customer Journey Analytics procesa los informes en el momento en que se ejecutan y distribuye el conjunto de datos combinado a varios servidores. El tamaño de la solicitud de datos y la cantidad de hardware de Adobe disponible son dos de los muchos factores que ayudan a determinar el número de servidores asignados para procesar un informe. Dado que los servidores se asignan dinámicamente y no son visibles en la interfaz, no hay forma de ver o controlar el número de servidores que procesan un informe.
...
Aunque es posible que falten algunos elementos de dimensión individuales en los informes de alta cardinalidad, los totales de columna son precisos y no se basan en datos truncados. La función de métrica calculada [[!UICONTROL Recuento aproximado distinto]](/help/components/calc-metrics/cm-adv-functions.md#approximate-count-distinct) tampoco se ve afectada por los elementos de dimensión truncados.
...
* Si el foco principal es el número de valores únicos, use la función de métrica calculada [[!UICONTROL Recuento distinto aproximado]](/help/components/calc-metrics/cm-adv-functions.md#approximate-count-distinct).
