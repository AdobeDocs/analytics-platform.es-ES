...
| Eliminar un conjunto de datos en [!UICONTROL Customer Journey Analytics] | Cuando elimina un conjunto de datos de una conexión en CJA, cualquier vista de datos y proyecto que dependa de ese conjunto de datos dejará de funcionar. |
