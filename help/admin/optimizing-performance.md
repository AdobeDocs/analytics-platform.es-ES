...
Varios factores pueden influir en el rendimiento general de CJA, así como en el rendimiento de un proyecto dentro de Analysis Workspace. En Workspace, podría recibir un mensaje de error que diga &quot;Este informe es demasiado complejo&quot;. [¿Es esta la redacción exacta del mensaje?] En este tema se describen los factores que pueden provocar este error y cómo simplificar el informe o proyecto.

## Rendimiento general de CJA
