...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Crear o editar una vista de datos](https://video.tv.adobe.com/v/345540/?captions=spa&quality=12&learn=on){target="_blank"} para ver un vídeo de demostración.
...
| [!UICONTROL **Año que incluye la semana “extra”**] | Con la mayoría de los calendarios de 364 días (52 semanas de 7 días cada uno), cada año se acumulan varios días restantes hasta formar una semana extra. Esta semana extra se agrega al último mes de ese año. Especifique a qué año desea agregar la semana adicional.<br><br/>**Semanas adicionales y años bisiestos**<br/> Al seleccionar un **[!UICONTROL tipo de calendario]** personalizado (**[!UICONTROL Personalizado (4-5-4)]**, **[!UICONTROL Personalizado (4-4-5)]** o **[!UICONTROL Personalizado (5-4-4)]**), los días restantes se acumulan cada año hasta que los días suman una semana adicional completa (7 días). Esa semana extra se agrega al año que seleccione en **[!UICONTROL Año en el que se produce la semana &quot;extra&quot;]**.<br/><br/>Los años bisiestos no se muestran intencionalmente en el **[!UICONTROL Año en el que se produce la semana &quot;extra&quot;]**. Sin embargo, un año bisiesto puede contener 53 semanas. Para forzar que un año bisiesto contenga 53 semanas, seleccione un año no bisiesto de **[!UICONTROL Año en el que se produce la semana &quot;extra&quot;]** para garantizar que la deriva de fecha acumulada sume hasta 7 días para el año bisiesto objetivo. Por ejemplo: para tener 53 semanas en 2024, seleccione **[!UICONTROL 2019]**. De 2019 a 2024, la deriva de fecha total es de 7 días (2020 (+2), 2021 (+1), 2022 (+1), 2023 (+1) y 2024 (+2)), lo que resulta en una semana 53 en 2024.<br/><br/>La selección de **[!UICONTROL Primer día del año actual]** afecta a dónde aterriza la semana extra. Confirme la configuración con la vista previa del calendario. |
...
1. Seleccione la pestaña **[!UICONTROL Configuración]**.
   ...
   Configuración de ![vista de datos](assets/dataview-settings.png)
...
Puede agregar segmentos que se apliquen a toda la vista de datos. Este segmento se aplica a cualquier informe que ejecute en Workspace. Arrastre un segmento de los componentes del carril izquierdo al campo **[!UICONTROL Agregar segmentos]**.
