...
* Las operaciones simples como [Minúsculas](./derived-fields.md#lowercase), [Recortar](./derived-fields.md#trim) o [Mayúsculas y minúsculas cuando](./derived-fields.md#case-when) comprueba la dirección URL de la página suelen ser más costosas que la misma lógica en los campos de baja cardinalidad.
...
* [Regex Replace](./derived-fields.md#regex-replace) o condiciones basadas en regex usan patrones amplios; las funciones [Case When](./derived-fields.md#case-when) más sencillas con **[!UICONTROL Contains]** o **[!UICONTROL Starts with]** son mejores alternativas.
...
[documentos](./derived-fields.md#limitations) de Customer Recorrido Analytics para funciones y operadores máximos por campo derivado, incluidos los límites por tipo de función.patrones**
