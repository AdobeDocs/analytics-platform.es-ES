...
>abstract="Esta función proporciona la capacidad de devolver la diferencia entre dos campos de fecha y hora. Los campos basados en personas (de conjuntos de datos de perfil) no tienen opciones para **[!UICONTROL Devolver el primero]** y **[!UICONTROL Devolver el último.]**."
