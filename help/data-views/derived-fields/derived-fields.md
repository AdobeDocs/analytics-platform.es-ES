...
>title="Typecast"
>abstract="Esta función proporciona la capacidad de cambiar el tipo de campo sobre la marcha para que el campo esté disponible para transformaciones adicionales en Customer Journey Analytics."

>[!CONTEXTUALHELP]
>id="dataview_derivedfields_depth"
>title="Profundidad"
>abstract="Esta función proporciona la capacidad de devolver la profundidad de cualquier campo, de forma similar a la funcionalidad del componente estándar de profundidad de evento."
