...
+ Introducción {#cja-overview}
  + Customer Journey Analytics {#cja-b2c-overview}
    ...
    + {hide-from-toc}[Comparación de productos de Analytics](/help/getting-started/analytics-product-comparison.md)
...
+ Actualizar y comparar {#compare-aa-cja}
  + Actualizar a Customer Journey Analytics {#upgrade-to-cja}
    + {hide-from-toc}[Introducción](/help/getting-started/cja-upgrade/cja-upgrade-getstarted.md)
    + {hide-from-toc}[Elija su ruta de actualización](/help/getting-started/cja-upgrade/cja-upgrade-path.md)
    + {hide-from-toc}[Enviar datos a la plataforma](/help/getting-started/cja-upgrade/cja-upgrade-send-to-platform.md)
    + {hide-from-toc}[Conservar datos históricos](/help/getting-started/cja-upgrade/cja-upgrade-historical-data.md)
    + [Proceso de actualización recomendado](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md)
    + [Prepare su organización](/help/getting-started/cja-upgrade/cja-upgrade-org-readiness.md)
  ...
  + Comparar con Adobe Analytics {#cja-aa-comparison}
    ...
    + [Asignación de datos entre IMS](../getting-started/aa-vs-cja/mapping-data-ims-orgs.md)
  ...
  + Transición desde Google Analytics 4 {#ga-to-cja}
    + [Información general](/help/getting-started/ga-to-cja/home.md)
    + [Modelo de datos](/help/getting-started/ga-to-cja/data-model.md)
    + [Equivalentes del informe](/help/getting-started/ga-to-cja/reports.md)
    + [Diferencias de datos](/help/getting-started/ga-to-cja/compare-data.md)

+ Ingesta de datos {#cja-data-ingestion}
  + [Información general](../data-ingestion/data-ingestion.md)
  + Guías de inicio rápido de ingesta y uso{#ingest-use-guides}
    ...
    + [Datos ad hoc](/help/data-ingestion/adhoc.md)

+ Data Mirror {#cja-data-mirror}
  + [Información general](/help/data-mirror/data-mirror.md)
  + Configuración {#configure}
    + [Soluciones nativas del almacén de datos](/help/data-mirror/datawarehouse.md)
...
+ Vistas de datos {#cja-dataviews}
  ...
  + Configuración de componentes {#component-settings}
    ...
    + {hide-from-toc}[Ámbito](/help/data-views/component-settings/scope.md)
...
+ Proyectos de Workspace {#cja-workspace}
  ...
  + Visualizaciones {#visualizations}
    ...
    + Tabla de forma libre {#freeform-table}
      ...
      + [Ver datos de tendencias](/help/analysis-workspace/visualizations/freeform-table/freeform-table-trended-data.md)
      + [Incluir varias dimensiones](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
  ...
  + Depurar y compartir {#curate-share}
    ...
    + [Generar presentaciones de diapositivas](/help/analysis-workspace/curate-share/generate-slides.md)
  + Exportar {#export}
...
+ Componentes {#cja-components}
  ...
  + Segmentos {#segments}
    ...
    + [Análisis de subeventos](/help/components/segments/sub-event.md)
  ...
  + Exportaciones {#exports}
    ...
    + Fuentes de datos {#cja-data-feeds}
      ...
      + {hide-from-toc}[Subeventos en fuentes de datos](/help/components/exports/cja-data-feeds/df-sub-event.md)
...
+ Unión {#stitching}
  ...
  + [Habilitación de la vinculación](/help/stitching/use-stitching-ui.md)
  + [Validar vinculación](/help/stitching/validate.md)
  + [Preguntas frecuentes](/help/stitching/faq.md)
  + B2B {#b2b}
    + [Vinculación de persona a cuenta](/help/stitching/b2b/b2b-person-to-account-stitching.md)

+ Total de informes de población {#tpr}
  + {hide-from-toc}[Información general](/help/tpr/tpr.md)
  + {hide-from-toc}[búsquedas compartidas](/help/tpr/shared-lookups.md)
...
+ Integraciones de Adobe {#integrations}
  ...
  + [Integrar Visibilidad de la marca](/help/integrations/bv.md)
...
+ Casos prácticos {#cja-usecases}
  ...
  + Datos complejos {#complex-data}
    ...
    + [Gestión Sin valor](../use-cases/data-views/no-value.md)
  ...
  + Exportación de datos {#data-export}
    ...
    + [Exportación de Workspace](../use-cases/data-export/workspace-export.md)
    + [Report Builder](../use-cases/data-export/report-builder.md)
    + [API de informes](../use-cases/data-export/reporting-api.md)
  ...
  + Datos de terceros {#third-party}
    ...
    + Métrica cuántica {#qm}
      ...
      + {hide-from-toc}[Conector de Source](/help/use-cases/third-party/quantum-metric/source-connector.md)

+ Labs {#labs}
  + [Guía del usuario de Labs](../labs/labs.md)

+ Solución de problemas {#troubleshooting}
  + [Comparar datos del conector fuente](../troubleshooting/compare.md)
...
+ Notas técnicas {#technotes}
  ...
  + [ID incorrectos](/help/technotes/badids.md)
  + [Explorador e idioma](/help/technotes/browser-language.md)
...
+ [Servidor MCP de Customer Journey Analytics](https://developer.adobe.com/analytics-mcp/docs/cja/)
