...
+ Proyectos de Workspace {#cja-workspace}
   ...
   + Depurar y compartir {#curate-share}
      ...
      + [Generar presentaciones](/help/analysis-workspace/curate-share/generate-presentations.md)
   + Exportar {#export}
...
+ Casos prácticos {#cja-usecases}
   ...
   + Campos derivados {#derived-fields}
      + [Informe sobre el tráfico generado por LLM y AI](/help/use-cases/ai-traffic.md)
...
+ Solución de problemas {#troubleshooting}
   + [Comparar datos del conector de Source](../troubleshooting/compare.md)
