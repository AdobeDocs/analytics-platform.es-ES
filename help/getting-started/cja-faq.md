...
| ¿Qué pasa si alguien...? | Esto sucede... |
| --- | --- |
| Elimina un entorno limitado en [!UICONTROL Adobe Experience Platform]? | Al eliminar un simulador para pruebas se romperá cualquier [!UICONTROL Customer Journey Analytics] conexiones a conjuntos de datos en ese entorno limitado. Sin embargo, los conjuntos de datos en CJA no se eliminarán en este momento. |
