...
| Paneles | El panel en blanco, el panel de atribución y el panel improvisado son totalmente compatibles. La comparación de segmentos no es compatible. |
...
| Función | Notas |
| --- | --- |
| Detección de anomalías | Se ha planificado lanzar una versión compatible. |
