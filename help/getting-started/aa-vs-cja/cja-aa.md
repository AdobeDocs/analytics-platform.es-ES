...
| Vinculación entre dispositivos y canales | Admitido para conjuntos de datos que contienen información de identidad directamente (es decir, vinculación “basada en el campo”); la vinculación basada en gráficos aún no es compatible, pero está planificada. Consulte [Cross-Channel Analytics](/help/connections/cca/overview.md). |
