...
| Conversión de moneda | Se admite como parte del [formato de un componente de métrica](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/format.html#currency) en una vista de datos. |
