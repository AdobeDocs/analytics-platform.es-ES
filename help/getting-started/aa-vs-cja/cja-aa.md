...
Las siguientes tablas indican qué funciones son únicas de Customer Journey Analytics y qué Adobe Analytics es compatible, parcialmente compatible o no compatible con Customer Journey Analytics. Estas listas cambiarán con el tiempo a medida que se añadan funciones a Customer Journey Analytics.

## Funciones exclusivas de Adobe Customer Journey Analytics {#cja-not-aa}
...
| **Análisis guiado** | El [Análisis guiado](/help/guided-analysis/overview.md) es un formato de informes que permite a los usuarios autoabastecer rápidamente sus necesidades de datos para que puedan obtener perspectivas de alta calidad rápidamente y tomar más decisiones basadas en datos. El análisis guiado forma parte del Adobe Product Analytics. |
...
| **Informes de alza y confianza** | Compatibilidad total a través del [panel Experimentación](/help/analysis-workspace/c-panels/experimentation.md) |
...
| **Cuadro de resultados móvil/Paneles** | Compatibilidad total |
...
| **Informes/proyectos programados** | Compatibilidad total |
...
| **Complemento de recopilación de medios de streaming** | Los datos de medios de streaming están disponibles mediante el conector de datos de Analytics como parte del panel Visualizadores simultáneos de medios y el panel Tiempo invertido en la reproducción de medios de Workspace. |
...
| **Publicación de audiencias** | Compatible si tiene licencia con la plataforma de datos del cliente o los productos de Journey Optimizer de Adobe. [Publicación de audiencias](/help/components/audiences/audiences-overview.md) envía audiencias al perfil del cliente en tiempo real en Experience Platform. |
...
| **Alertas inteligentes** | El proceso de usar [Alertas inteligentes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/alerts/intellligent-alerts) en Customer Journey Analytics es casi idéntico al de usar Alertas inteligentes en Adobe Analytics. Sin embargo, existen [diferencias importantes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/alerts/alerts-feature-comparison). |
...
| **Vinculación entre dispositivos y canales** | Admitido para conjuntos de datos de eventos que contienen información de identidad. Consulte [Vinculación](../../stitching/overview.md). |
