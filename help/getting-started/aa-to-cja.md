...
### 3. (Re)Configuración de los canales de marketing
...
### 4. Decida si utilizar el conector de origen de Analytics o los SDK de Experience Platform
...
### Identificación de segmentos críticos y métricas calculadas
