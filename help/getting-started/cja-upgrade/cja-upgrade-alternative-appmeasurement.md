...
1. Migre su implementación de Adobe Analytics para utilizar Adobe Experience Platform Web SDK y comience a enviar datos a Edge Network.
   ...
   * [Migración al SDK web mediante etiquetas](https://experienceleague.adobe.com/es/docs/analytics/implementation/aep-edge/web-sdk/analytics-extension-to-web-sdk)

   * [Migración al SDK web mediante JavaScript](https://experienceleague.adobe.com/es/docs/analytics/implementation/aep-edge/web-sdk/appmeasurement-to-web-sdk)
