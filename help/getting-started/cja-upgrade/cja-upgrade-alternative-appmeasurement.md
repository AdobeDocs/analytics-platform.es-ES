...
1. Migre su implementación de Adobe Analytics para utilizar Adobe Experience Platform Web SDK y comience a enviar datos a Edge Network.
   ...
   Este paso le permite migrar los Adobe Analytics existentes implementación utilizar el SDK web. Opcionalmente, puede enviar datos a Adobe Analytics para validar que todo funciona en Adobe Analytics antes de enviar datos a Customer Journey Analytics. Después de configurarlo y de que los datos de Adobe Analytics sean satisfactorios, puede enviar datos de la red perimetral a Customer Journey Analytics.

   Esta flexibilidad le permite una actualización más metódica y meditada a Customer Journey Analytics.
...
1. Comience a enviar datos de Edge Network a Platform.
   ...
   1. Elija su esquema.
      ...
      Adobe Systems recomienda crear una esquema XDM. Para obtener más información, consulte [Crear un esquema personalizado que utilizar con el implementación del SDK web de Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-schema-create.md).

      +++Utilizar el Adobe Analytics esquema
