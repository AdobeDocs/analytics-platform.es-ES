...
# Evalúe cuánto tiempo necesita Adobe Analytics después de actualizar a Customer Journey Analytics {#evaluate-aa-needs}

<!-- markdownlint-disable MD034 -->

>[!CONTEXTUALHELP]
>id="cja-upgrade-fully-move"
>title="Mover completamente al Customer Journey Analytics"
>abstract="(Recomendado) El Customer Journey Analytics pretende ser la principal herramienta de Analytics para su organización. Sin embargo, es posible que su organización siga necesitando Adobe Analytics si depende en gran medida de funciones exclusivas de la herramienta y esos flujos de trabajo no se pueden modificar."
...
>abstract="(No recomendado) Si selecciona esta opción, el contrato con Adobe incluye Adobe Analytics y Customer Journey Analytics, lo que puede resultar más caro para su organización a lo largo del tiempo."
...
|---------|----------|
| Realizar comparación de datos en paralelo | Adobe recomienda mantener el entorno de Adobe Analytics en ejecución durante un periodo de tiempo después de que el nuevo entorno de Customer Journey Analytics se esté ejecutando y recopile datos. Esta es la mejor manera de comparar los datos de Customer Journey Analytics en paralelo con los datos de Adobe Analytics.<p>No desactive Adobe Analytics hasta que se sienta cómodo con los datos de su entorno de Customer Journey Analytics.</p><p>**Nota:** el Adobe recomienda una nueva implementación de Web SDK para su entorno de Customer Journey Analytics, junto con el conector de origen de Analytics para los datos históricos. [Más información](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md)</p> |
| Conservar datos históricos de Adobe Analytics | El Adobe recomienda mantener el entorno de Adobe Analytics en su lugar con el conector de origen de Analytics durante un período de tiempo después de que el nuevo entorno de Customer Journey Analytics se esté ejecutando y recopile datos. Esta es la mejor manera de llevar los datos del historial de Adobe Analytics a Customer Journey Analytics.<p>Después de haber recopilado suficientes datos históricos en Customer Journey Analytics con la nueva implementación de Web SDK, puede quitar el conector de origen de Analytics por completo. Haga esto cuando pueda confiar únicamente en los datos históricos que ha recopilado con la nueva implementación de Customer Journey Analytics Web SDK.</p><p>**Nota:** el Adobe recomienda una nueva implementación de Web SDK para su entorno de Customer Journey Analytics, junto con el conector de origen de Analytics para los datos históricos. [Más información](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md)</p> |
...
1. Deje de recopilar datos con Adobe Analytics.
   ...
   Una vez que esté satisfecho con las comparaciones paralelas de los datos de Adobe Analytics y los datos de los Customer Journey Analytics, puede dejar de recopilar datos con la implementación de Adobe Analytics. Los nuevos datos de Adobe Analytics ya no fluirán al Customer Journey Analytics a través del conector de origen de Analytics.
...
+++ Terceros
   ...
   Póngase en contacto con el administrador de etiquetas para eliminar la biblioteca de AppMeasurementes de su sistema de administración de etiquetas de terceros.
