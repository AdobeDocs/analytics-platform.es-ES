...
| <span class="preview">**Paso 2: Elija la ruta de actualización**</span> | <span class="preview">Hay varios métodos disponibles para actualizar a Customer Journey Analytics. Elija el método que mejor se adapte a su organización, según el entorno de Adobe Analytics actual de su organización y los objetivos a largo plazo.</span> |
...
| Implementación de Adobe Analytics existente | Rutas de actualización disponibles |
|---------|----------|
