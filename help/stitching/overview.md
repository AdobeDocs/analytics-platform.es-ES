...
La configuración vuelve a incrustar las identidades dentro de las filas de un conjunto de datos para garantizar que la información de ID de persona deseada esté disponible en tantos eventos como sea posible. La configuración busca los datos de usuario de las sesiones autenticadas y no autenticadas para determinar el valor de ID de persona común que se puede utilizar. Esta regeneración de claves resuelve registros dispares en un ID de persona único para su análisis en el nivel de persona, en lugar de en el nivel de dispositivo o cookie. Sin embargo, si no se puede determinar un valor de ID de persona común, se utiliza el valor de ID persistente en su lugar.
