...
1. Clic **[!UICONTROL Crear nuevo]** para ver las distintas opciones de vista y elegir un punto de partida diferente para el análisis.
   ...
   ![Crear un nuevo modal](assets/create-new-modal.png){style="border:1px solid gray"}
...
Una vez que la organización esté aprovisionada para utilizar el análisis guiado, los administradores de perfil de producto pueden agregar o eliminar el acceso a él en Adobe Admin Console.
