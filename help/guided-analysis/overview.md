...
| --- | --- | --- |
| [!UICONTROL Matriz de características] | [Participación](types/engagement.md) | Comprenda la amplitud y la anchura de la participación de las funciones. |
...
1. Haga clic en el icono de signo más situado junto a **[!UICONTROL Acceso guiado a análisis]** en la lista de [!UICONTROL Elementos de permisos disponibles], que lo añade a la lista de [!UICONTROL Elementos de permisos incluidos].
