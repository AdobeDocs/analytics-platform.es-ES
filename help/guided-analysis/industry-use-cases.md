...
![Análisis de tendencias para los servicios financieros](assets/fsi-trends-usage.png){style="border:1px solid gray"}
...
| Caso de uso | Ejemplo | Impacto | Análisis |
| --- | --- | --- | --- |
| **Cuantificar el impacto de las nuevas características de flujo de reservas** | Una organización utiliza el análisis guiado para ver el impacto de una nueva función de pasos de reserva en las tasas de conversión rápidamente. Identifican la parte de la experiencia con las mayores ganancias. | **Aumente las tarifas de reserva.** Mida el impacto en la empresa en lugar de usar solamente las funciones. | [Análisis de impacto de la versión](types/release-impact.md)<br>[Análisis de canal](types/funnel.md) |
...
| **Encuentre fricción en el flujo de facturación móvil** | Ver si las personas tienen éxito o abandonan el proceso de registro móvil esperado permite a una organización identificar fácilmente las áreas para la optimización de experiencias. | **Aumente el CSAT y reduzca los IROP.** La eliminación de la fricción conduce a una experiencia de “día de viaje” más fluida. | [Análisis de canal](types/funnel.md)<br>[Análisis de tendencias de conversión](types/conversion-trends.md) |
| **Desviar llamadas al centro de llamadas** | Ver la experiencia del usuario en un análisis de canal muestra a un usuario dónde los visitantes entran en fricción, lo que conduce a un costoso volumen del centro de llamadas. Los siguientes pasos en los que centrarnos son claros. | **Reduzca el uso del centro de llamadas.** Obtenga más experiencias de usuario de “ruta feliz” y reduzca las llamadas costosas. | [Análisis de canal](types/funnel.md)<br>[Análisis de tendencias de conversión](types/conversion-trends.md) |

{style="table-layout:auto"}

![Análisis de canal para viajes y hospitalidad](assets/th-funnel-friction.png){style="border:1px solid gray"}

![Análisis de tendencias para viajes y hospitalidad](assets/th-trends-usage.png){style="border:1px solid gray"}
...
![Análisis de crecimiento activo para medios y entretenimiento](assets/me-user-growth-active.png){style="border:1px solid gray"}
