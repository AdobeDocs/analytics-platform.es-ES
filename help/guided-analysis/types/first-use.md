...
* **Despliegues por fases**: Debido a que el análisis busca el primer uso de la función en lugar de una fecha fija, esta vista es útil si se modifica gradualmente el despliegue de las funciones a lo largo del tiempo.
